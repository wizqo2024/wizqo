  ...
  },
  {
    ...
    docs: [
      makeDoc({
        ...
        description: 'Unique design prompts that change with each generation - patterns, mandalas, and abstract art.',
        grades: ['preK', 'k1', 'g2'],
        difficulty: 'Beginner',
        focus: ['creativity', 'design', 'fine motor'],
      }),
      makeDoc({
        id: 'interactive-art-colorwheel',
        title: 'Color Theory Practice',
        description: 'Learn primary, secondary, and complementary colors with interactive exercises.',
        grades: ['k1', 'g2', '35'],
        difficulty: 'Beginner',
        focus: ['color theory', 'art basics', 'creativity'],
      }),
      makeDoc({
        id: 'interactive-art-sketch',
        title: 'Sketch & Observe',
        description: 'Observation drawing exercises with different subjects and prompts each time.',
        grades: ['g2', '35', '68'],
        difficulty: 'Intermediate',
        focus: ['drawing', 'observation', 'sketching'],
      }),
    ],
  },
  {
    ...
    docs: [
      ...
      makeDoc({
        id: 'interactive-early-reading-bridge',
        title: 'Reading Bridge Builders',
        description: 'Short fiction passages with story maps and vocabulary boosts for early elementary readers.',
        grades: ['g2'],
        difficulty: 'Beginner',
        focus: ['reading comprehension', 'story structure', 'vocabulary'],
      }),
      makeDoc({
        id: 'interactive-early-math-bridge',
        title: 'Math Bridge Practice',
        description: 'Two-digit addition, subtraction, and quick word problems to strengthen number sense.',
        grades: ['g2'],
        difficulty: 'Beginner',
        focus: ['addition', 'subtraction', 'word problems'],
      }),
      makeDoc({
        id: 'interactive-early-writing-bridge',
        title: 'Writing Bridge Workshop',
        description: 'Guided paragraph practice with transition words, revision checklists, and sentence starters.',
        grades: ['g2'],
        difficulty: 'Beginner',
        focus: ['writing process', 'sentence fluency', 'revision'],
      }),
    ],
  },
  {
