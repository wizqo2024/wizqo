...
export function initializeWorksheetSEO() {
  ...
  const allDocIds = [
    ...
    'add-sub-decimals', 'add-sub-fractions', 'add-sub-fractions-4th', 'add-sub-mixed-numbers', 'add-three-numbers',
    'animal-pack', 'area-model-mult', 'area-perimeter-4th', 'area-rectangles', 'area-triangles-parallelograms',
    'arts-3-shape-creature', 'balance-equations-10', 'bar-graphs-data', 'bar-graphs-pictographs', 'beginning-sounds-az',
    'big-small', 'bookmark-templates', 'brain-boost', 'classifying-angles', 'classifying-quadrilaterals',
    ...
    'decimal-word-problems', 'decimal-word-problems-5th', 'design-monster', 'directed-drawing-animals', 'div-by-10-100',
    'div-facts-1-12', 'dividing-decimals', 'dividing-fractions', 'div-with-remainders', 'div-word-problems',
    'dot-to-dot-1-20', 'doubles-facts', 'doubles-near-doubles', 'draw-half', 'draw-shape',
    'elapsed-time-4th', 'elapsed-time-word-problems', 'equivalent-fractions', 'equivalent-fractions-4th', 'estimating-sums-differences',
    'evaluating-expressions', 'even-odd-100', 'expanded-form-200', 'fact-families-20', 'fact-families-mult-div',
    ...
    'fractions-to-decimals', 'fractions-to-decimals-basic-tenths', 'fractions-to-decimals-division', 'fractions-whole', 'fraction-word-problems',
    'fraction-word-problems-5th', 'div-fractions', 'geo-compass-rose', 'geo-continents-k2', 'geo-landforms',
    'geo-latlong', 'geometry-word-problems', 'grammar-detective', 'gratitude-jar', 'halloween-pack',
    'heavy-light', 'hidden-object', 'how-many-1-15', 'identify-polygons', 'letter-tracing-az',
    'line-graphs', 'line-plots', 'lines-angles-4th', 'lines-rays-angles', 'liquid-measurement',
    'liquid-measurement-4th', 'logic-grid', 'long-division-1digit', 'long-division-2digit', 'long-division-multidigit',
    'long-short', 'mandalas', 'mass-weight', 'mass-weight-4th', 'math-maze',
    'maze-focus', 'mean-median-mode', 'mean-median-mode-range', 'measurement-length', 'measurement-word-problems',
    'mental-math-20', 'metric-conversion', 'metric-units', 'missing-addends', 'missing-addends-10',
    'missing-factors-mult', 'missing-numbers-50', 'missing-number-sequence', 'missing-shape', 'mixed-improper-fractions',
    'money-coins-bills', 'money-identifying-coins', 'money-word-problems', 'mood-tracker', 'more-less',
    'more-less-equal-10', 'mult-2x1', 'mult-2x1-digit', 'mult-2x2', 'mult-2x2-digit',
    'mult-3x2-digit', 'mult-area-model', 'mult-arrays', 'mult-arrays-2-5', 'mult-arrays-models',
    'mult-by-10-100', 'mult-complex-word', 'mult-fact-families', 'mult-fact-fluency', 'mult-facts-0-12',
    'mult-facts-1-5', 'mult-facts-6-12', 'multiplication-color-by-number', 'multiplying-decimals', 'multiplying-fractions',
    'multi-step-word-4th', 'multi-step-word-5th', 'multi-step-word-problems', 'mult-lattice', 'mult-mixed-review',
    'mult-multi-step-word', 'mult-patterns', 'mult-properties', 'mult-strategies', 'mult-word-problems',
    'mult-word-problems-2-3', 'mult-word-problems-4th', 'name-writing', 'nets-3d-shapes', 'number-bonds-10',
    'number-id-1-10', 'number-id-20', 'number-line-200', 'number-line-add', 'number-line-id-20',
    'number-line-skip-count', 'number-line-sums-differences', 'number-matching-1-10', 'number-matching-1-15', 'number-order-1-20',
    'number-order-1-30', 'number-patterns', 'number-patterns-200', 'number-patterns-subtraction', 'number-recognition-120',
    'number-tracing-1-10', 'number-tracing-1-20', 'number-tracing-1-30', 'number-words-1-10', 'number-words-11-20',
    'odd-even-sorting', 'one-more-one-less', 'ordering-fractions-decimals', 'ordering-numbers-100', 'order-of-operations',
    'partial-products', 'path-tracing', 'pattern-complete', 'patterns-rules', 'pemdas-advanced',
    'pemdas-basic', 'pemdas-complex', 'pemdas-exponents', 'pemdas-fluency', 'pemdas-mixed-review',
    'pemdas-multistep', 'pemdas-parentheses', 'pemdas-practice', 'pemdas-rules', 'pemdas-step-by-step',
    'pemdas-word-problems', 'percent-to-decimal', 'percent-word-problems', 'perimeter-area-word-problems', 'perimeter-rectangles',
    'perimeter-shapes', 'phonics-short-a', 'phonics-short-e', 'phonics-short-i', 'phonics-short-o',
    'phonics-short-u', 'picture-addition-10', 'place-value-blocks-100', 'place-value-expansion-100', 'place-value-hto',
    'place-value-hundreds', 'place-value-tens-ones', 'powers-of-10', 'prime-composite', 'probability',
    'ratio-proportion-word-problems', 'reading-comprehension-grade-1', 'reading-comprehension-grade-2', 'reading-comprehension-grade-3', 'reading-comprehension-grade-4',
    'reading-comprehension-grade-5', 'reading-discovery-interactive', 'reading-g1-ants', 'reading-g1-big-box', 'reading-g1-birthday-cake',
    'reading-g1-bus-ride', 'reading-g1-garden-snail', 'reading-g1-lost-hat', 'reading-g1-pet-fish', 'reading-g1-red-balloon',
    'reading-g2-bird-feeder', 'reading-g2-cookie-recipe', 'reading-g2-library-card', 'reading-g2-lost-and-found', 'reading-g2-magic-seeds',
    'reading-g2-paper-bridge', 'reading-g2-rainy-garden', 'reading-g2-tree-house', 'reading-g3-art-project', 'reading-g3-community-garden',
    'reading-g3-lighthouse', 'reading-g3-school-play', 'reading-g3-science-fair', 'reading-kindergarten', 'reading-mini-1',
    'reward-chart', 'rhyming-words', 'rounding-decimals', 'rounding-decimals-5th', 'rounding-nearest-10',
    'rounding-nearest-10-100', 'same-different', 'school-survival-kit', 'science-lifecycle', 'science-match',
    'sentence-building', 'sentence-scramble', 'shape-identification', 'shape-patterns', 'shapes-all-around',
    'shapes-az', 'shapes-coloring', 'shapes-colors-sort', 'shape-sorting', 'sight-words-pre-primer',
    'size-comparison', 'skip-count-10', 'skip-count-2', 'skip-count-2-10', 'skip-count-2s',
    'skip-count-5', 'skip-count-5-10-120', 'skip-counting-by-2s-to-50', 'skip-counting-by-5s-to-100', 'skip-counting-missing',
    'skip-count-mult', 'solving-one-step-equations', 'spatial-awareness', 'spatial-logic-blocks', 'spelling',
    'spot-difference', 'spring-scavenger', 'stem-balloon-rocket', 'stem-leaf-plots', 'stem-walking-water',
    'sub-2digit-100', 'sub-2digit-regrouping', 'subtraction-stories', 'sudoku4', 'sudoku6',
    'summer-pack', 'symmetry', 'symmetry-transformations', 'tangram-animals', 'telling-time-5min',
    'telling-time-analog-clocks', 'telling-time-half-hour', 'telling-time-quarter-hour', 'telling-time-to-the-hour', 'ten-frames-1-10',
    'ten-frames-11-20', 'ten-frames-1-20', 'thickness-heavy-light', 'time-5min', 'times-table-blank-1-12',
    'times-table-blank-1-5', 'times-table-blank-6-12', 'times-table-color-1-12', 'times-table-color-1-5', 'times-table-color-6-12',
    'times-table-confidence-1-5', 'times-table-confidence-6-12', 'times-table-fluency-1-12', 'times-table-horizontal-1-12', 'times-table-horizontal-1-5',
    'times-table-horizontal-6-12', 'times-table-missing-1-5', 'times-table-missing-6-12', 'times-table-missing-mixed', 'times-table-mixed-review',
    'times-table-timed-1-12', 'times-table-timed-1-5', 'times-table-timed-6-12', 'times-table-vertical-1-12', 'times-table-vertical-1-5',
    'times-table-vertical-6-12', 'time-to-minute', 'tracing-alphabet', 'tracing-letters', 'tracing-lowercase',
    'tracing-numbers-1-10', 'tracing-numbers-1-20', 'tracing-uppercase', 'transformations-5th', 'two-digit-addition-no-regrouping',
    'two-digit-addition-with-regrouping', 'two-digit-subtraction-no-regrouping', 'two-digit-subtraction-with-regrouping', 'unitary-method-5th', 'uppercase-alphabet',
