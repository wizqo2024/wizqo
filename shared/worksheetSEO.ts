...
export function initializeWorksheetSEO() {
  ...
  const allDocIds = [
    ...
    'count-match-1-20', 'count-write-30', 'creative-challenge', 'curve-tracing', 'customary-conversion',
    ...
    'feelings-checkin', 'find-number-1-10', 'fractions-decimals-percents', 'fractions-decimals-percents-advanced',
