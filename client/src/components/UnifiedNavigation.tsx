          ...
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <div className="relative group">
                <a href="/interactive-worksheets-generator" className={`flex items-center space-x-2 px-3 py-2 rounded-md transition-colors ${currentPage === 'interactive-worksheets-generator' || currentPage === 'worksheets' ? 'text-purple-600 bg-purple-50' : 'text-slate-600 hover:text-slate-800 hover:bg-slate-100'}`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="absolute top-full left-0 mt-1 w-56 bg-white rounded-lg shadow-lg border border-slate-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="py-2">
                    <a href="/interactive-worksheets-generator" className="block px-4 py-2 text-sm text-slate-700 hover:bg-purple-50 hover:text-purple-700">
                    ...
                    <a href="/worksheets/1st-grade-math-worksheets" className="block px-4 py-2 text-sm text-slate-700 hover:bg-purple-50 hover:text-purple-700">
                      1st Grade Math
                    </a>
                    <a href="/worksheets/reading-comprehension" className="block px-4 py-2 text-sm text-slate-700 hover:bg-purple-50 hover:text-purple-700">
                      Reading Comprehension
                    </a>
                    <a href="/worksheets/handwriting-worksheet-maker" className="block px-4 py-2 text-sm text-slate-700 hover:bg-purple-50 hover:text-purple-700">
                      Handwriting
                    </a>
                  </div>
                </div>
