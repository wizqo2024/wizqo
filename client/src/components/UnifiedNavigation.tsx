                  ...
                  <div className="grid gap-0 min-w-[320px] md:grid-cols-3 w-full md:gap-0">
                    ...
                    <div className="-mx-1">
                      ...
                      <a href={addLocaleToPath("/worksheets/scissor-skills-generator", getLocaleFromURL())} className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-slate-700 hover:bg-slate-50 transition-colors">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="text-xs font-semibold text-slate-800 whitespace-nowrap">{t('navigation.scissorSkillsGenerator')}</div>
                          <div className="text-[10px] text-slate-600 truncate">{t('navigation.scissorSkillsGeneratorDesc')}</div>
                        </div>
                      </a>
                      <a href={addLocaleToPath("/worksheets/counting-numbers-generator", getLocaleFromURL())} className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-slate-700 hover:bg-slate-50 transition-colors">
                        <svg className="w-4 h-4 text-slate-500 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="text-xs font-semibold text-slate-800 whitespace-nowrap">{t('navigation.countingNumbersGenerator')}</div>
                          <div className="text-[10px] text-slate-600 truncate">{t('navigation.countingNumbersGeneratorDesc')}</div>
                        </div>
                      </a>
                      <a href={addLocaleToPath("/worksheets/dot-marker-generator", getLocaleFromURL())} className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-slate-700 hover:bg-slate-50 transition-colors">
                        <svg className="w-4 h-4 text-slate-500 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          <circle cx="12" cy="12" r="10" />
                          <circle cx="12" cy="12" r="3" fill="currentColor" />
                        </svg>
                        <div className="min-w-0 flex-1">
                          <div className="text-xs font-semibold text-slate-800 whitespace-nowrap">{t('navigation.dotMarkerGenerator')}</div>
                          <div className="text-[10px] text-slate-600 truncate">{t('navigation.dotMarkerGeneratorDesc')}</div>
                        </div>
                      </a>
                    </div>
            ...
            <div>
              ...
              <div className="pl-7 pt-2 space-y-1">
                ...
                <button
                  ...
                  className="w-full flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-colors text-left text-slate-700 hover:text-purple-700 hover:bg-purple-50 active:bg-purple-100"
                >
                  <span className="text-sm font-medium">{t('navigation.scissorSkillsGenerator')}</span>
                </button>
                <button
                  onClick={() => {
                    window.location.href = addLocaleToPath('/worksheets/counting-numbers-generator', getLocaleFromURL());
                    setShowMobileMenu(false);
                  }}
                  className="w-full flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-colors text-left text-slate-700 hover:text-purple-700 hover:bg-purple-50 active:bg-purple-100"
                >
                  <span className="text-sm font-medium">{t('navigation.countingNumbersGenerator')}</span>
                </button>
                <button
                  onClick={() => {
                    window.location.href = addLocaleToPath('/worksheets/dot-marker-generator', getLocaleFromURL());
                    setShowMobileMenu(false);
                  }}
                  className="w-full flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-colors text-left text-slate-700 hover:text-purple-700 hover:bg-purple-50 active:bg-purple-100"
                >
                  <span className="text-sm font-medium">{t('navigation.dotMarkerGenerator')}</span>
                </button>
