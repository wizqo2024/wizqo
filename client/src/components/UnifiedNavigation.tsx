              ...
              <div className="relative">
                ...
                >
                  ...
                  <a href="/worksheets/1st-grade-math-worksheets" className="flex items-center gap-2 px-3 py-2 rounded-md text-slate-700 hover:bg-slate-50 border-t border-slate-100">
                    ...
                    <span>1st Grade Math Worksheets</span>
                  </a>
                  ...
                  <a href="/worksheets/reading-comprehension" className="flex items-center gap-2 px-3 py-2 rounded-md text-slate-700 hover:bg-slate-50 border-t border-slate-100">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M4 19h16M4 5h16M7 12h10" />
                    </svg>
