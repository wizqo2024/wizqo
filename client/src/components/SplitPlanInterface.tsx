          ...
          {(planData && planData.days && planData.days.length > 0) ? (
            <div className="p-4 lg:p-6">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                <div>
                  <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">{planData.title || `Master ${planData.hobby} in 7 Days`}</h1>
                  <p className="text-gray-600 max-w-2xl">{planData.overview || planData.description}</p>
                </div>
                <div className="mt-4 lg:mt-0">
                  <div className="flex items-center space-x-4">
                    <div className="text-sm text-gray-600">
                      <span className="font-medium">{completedDays.length}</span> of {planData.totalDays || 7} days completed
                    </div>
              ...
              {/* Day Content */}
              {(() => {
                const currentDay = planData?.days?.[selectedDay - 1];
                        ...
                        >
                          <div className="max-w-4xl">
                            <div className="flex items-center mb-4">
                              ...
                              <span className="text-sm font-semibold uppercase tracking-wider opacity-90">Main Task</span>
                            </div>
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 leading-tight">{currentDay.mainTask}</h2>
                            <p className="text-lg opacity-90 leading-relaxed max-w-3xl">{currentDay.explanation}</p>
                          </div>
                        </div>
                        ...
                        <div className="p-6 md:p-8 space-y-8">
                          ...
                          <section>
                            <div className="flex items-center mb-4">
                              ...
                              <h3 className="text-lg md:text-xl font-bold text-blue-900">Why This Matters</h3>
                            </div>
                            <div className="bg-blue-50 rounded-lg p-4">
                              <p className="text-blue-800 leading-relaxed">{currentDay.explanation}</p>
                            </div>
                          </section>
                          ...
                          <section>
                            <div className="flex items-center mb-4">
                              ...
                              <h3 className="text-lg md:text-xl font-bold text-purple-900">Step-by-Step Guide</h3>
                            </div>
                            <div className="space-y-3">
                              {currentDay.howTo && currentDay.howTo.length > 0 ? currentDay.howTo.map((step, index) => (
                                <div key={index} className="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow border-l-4 border-purple-400">
                                  <div className="flex items-start">
                                    <div className="bg-purple-100 rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">
                                ...
                                <p className="text-gray-500 italic">No specific steps provided for this day.</p>
                              )}
                            </div>
                          </section>
                          ...
                          <section>
                            <div className="flex items-center mb-4">
                              ...
                              <h3 className="text-lg md:text-xl font-bold text-red-900">Video Tutorial</h3>
                            </div>
                            <div className="bg-black rounded-lg overflow-hidden">
                              ...
                              <YouTubeEmbed 
                                ...
                                title={currentDay.videoTitle || `${currentDay.title} - ${planData?.hobby || 'Tutorial'} Tutorial`} 
                                className="w-full"
                              />
                            </div>
                          </section>
                          ...
                          <section>
                            <div className="flex items-center mb-4">
                              ...
                              <h3 className="text-lg md:text-xl font-bold text-green-900">Tips for Success</h3>
                            </div>
                            <div className="space-y-2">
                              {currentDay.tips && currentDay.tips.length > 0 ? currentDay.tips.map((tip, index) => {
                                ...
                                <p className="text-gray-500 italic">No specific tips provided for this day.</p>
                              )}
                            </div>
                          </section>
                          ...
                          <section>
                            <div className="flex items-center mb-4">
                              ...
                              <h3 className="text-lg md:text-xl font-bold text-orange-900">Avoid These Mistakes</h3>
                            </div>
                            <div className="space-y-2">
                              {(() => {
                                ...
                                return (
                                  <div key={index} className="bg-white rounded-lg p-3 shadow-sm hover:shadow-md transition-shadow border-l-3 border-red-400">
                                    <div className="flex items-start">
                                      ...
                                      <p className="text-gray-700 leading-relaxed text-sm">{mistake}</p>
                                    </div>
                                  </div>
                                );
                              }) : (
                                <p className="text-gray-500 italic">No common mistakes listed for this day.</p>
                              )}
                            </div>
                          </section>
                          ...
                          <section>
                            <div className="flex items-center mb-4">
                              ...
                              <h3 className="text-lg md:text-xl font-bold text-indigo-900">Today's Checklist</h3>
                            </div>
                            <div className="bg-indigo-50 rounded-lg p-4">
                              <div className="space-y-2">
                                {currentDay.checklist && currentDay.checklist.length > 0 ? currentDay.checklist.map((item, index) => (
                                  <div key={index} className="flex items-center">
                                    <div className="bg-indigo-100 rounded w-4 h-4 flex items-center justify-center mr-3 flex-shrink-0">
                                      <Circle className="w-3 h-3 text-indigo-600" />
                                    </div>
                                    <span className="text-indigo-800 text-sm">{item}</span>
                                  </div>
                                )) : (
                                  <p className="text-indigo-600 italic">No checklist items for this day.</p>
                                )}
                              </div>
                            </div>
                          </section>
            ...
            // ENHANCED LOADING UI - Better user experience during plan generation
            <div className="flex-1 flex items-center justify-center min-h-full p-6 bg-gradient-to-br from-blue-50 to-purple-50">
              <div className="max-w-lg w-full mx-auto text-center space-y-8">
                {/* Main Loading Animation */}
                <div className="relative">
                  <div className="w-20 h-20 mx-auto mb-6">
                    <div className="absolute inset-0 border-4 border-blue-200 rounded-full"></div>
                    <div className="absolute inset-0 border-4 border-blue-600 rounded-full border-r-transparent animate-spin"></div>
                  ...
                  {/* Pulsing effect */}
                  <div className="absolute inset-0 w-20 h-20 mx-auto border-4 border-blue-300 rounded-full animate-pulse opacity-20"></div>
                </div>
                
                {/* Title and Description */}
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">Creating Your Learning Plan</h2>
                  <p className="text-lg text-gray-600 mb-6">
                    AI is crafting a personalized 7-day journey for {selectedHobby || 'your chosen hobby'}...
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-green-700 font-medium">Analyzing your learning goals</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-blue-700 font-medium">Building 7-day curriculum</span>
                    </div>
                    <div className="w-4 h-4 border-2 border-blue-500 border-r-transparent rounded-full animate-spin"></div>
                  </div>
                  
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-gray-300 rounded-full"></div>
                      <span className="text-gray-500">Finding tutorial videos</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-gray-300 rounded-full"></div>
                      <span className="text-gray-500">Preparing resources & tips</span>
                    </div>
                    <span className="text-gray-400">○</span>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 border border-blue-200">
                  ...
                  <p className="text-xs text-gray-600 leading-relaxed">
                    Research shows that structured 7-day learning plans can help you build lasting habits and achieve 3x better retention compared to random learning sessions!
                  </p>
                </div>
