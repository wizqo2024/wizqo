...
export default function MicroJournalingBlog() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 space-y-16 mt-8" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <section className="bg-white rounded-2xl shadow-xl p-6 md:p-8 border border-gray-200">
        <h2 className="text-2xl md:text-3xl font-bold text-[#264653] mb-8 text-center">The 48-Hour Challenge</h2>
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-4 md:gap-6">
          {/* Step 1 */}
          <div className="flex-1 bg-gray-50 p-5 md:p-6 rounded-lg border border-gray-200 relative">
            <div className="absolute -top-3 -left-3 bg-[#264653] text-white w-10 h-10 rounded-full flex items-center justify-center font-bold text-lg shadow-md z-10">1</div>
            <h3 className="text-lg md:text-xl font-bold text-[#264653] mb-2 mt-2">Day 1: The Reveal</h3>
            <p className="text-sm md:text-base text-gray-700 mb-3">Write 1 raw sentence about how you feel.</p>
            <div className="bg-white p-3 rounded border border-gray-200 italic text-gray-600 text-sm mb-3">
              "I feel overwhelmed by the project deadline..."
            </div>
            <span className="inline-block text-xs font-semibold text-[#E76F51] uppercase tracking-wide bg-red-50 px-3 py-1 rounded-full">No Filters.</span>
          </div>

          {/* Arrow Desktop */}
          <div className="hidden md:flex items-center justify-center text-[#2A9D8F] text-3xl font-bold flex-shrink-0">
            →
          </div>
          {/* Arrow Mobile */}
          <div className="md:hidden flex items-center justify-center text-[#2A9D8F] text-3xl font-bold py-2">
            ↓
          </div>

          {/* Step 2 */}
          <div className="flex-1 bg-gray-50 p-5 md:p-6 rounded-lg border border-gray-200 relative">
            <div className="absolute -top-3 -left-3 bg-[#2A9D8F] text-white w-10 h-10 rounded-full flex items-center justify-center font-bold text-lg shadow-md z-10">2</div>
            <h3 className="text-lg md:text-xl font-bold text-[#264653] mb-2 mt-2">Day 2: The Shift</h3>
            <p className="text-sm md:text-base text-gray-700 mb-3">Write 1 sentence about something you're proud you handled.</p>
            <div className="bg-white p-3 rounded border border-gray-200 italic text-gray-600 text-sm mb-3">
              "I kept my cool during that meeting today."
            </div>
            <span className="inline-block text-xs font-semibold text-[#2A9D8F] uppercase tracking-wide bg-teal-50 px-3 py-1 rounded-full">Notice the win.</span>
          </div>
          ...
          {/* Result */}
          <div className="flex-1 bg-gradient-to-br from-[#2A9D8F] to-[#264653] p-5 md:p-6 rounded-lg text-white flex flex-col justify-center text-center shadow-md">
            <h3 className="text-lg md:text-xl font-bold mb-4">The Result</h3>
