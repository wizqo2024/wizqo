      ...
      <section className="text-center">
        ...
        <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-xl border border-slate-200">
          ...
          <ul className="space-y-3 text-left w-fit mx-auto">
            <li className="flex items-center"><span className="text-green-700 text-2xl mr-3">🧘</span>Take one deep breath before reacting — a step toward <strong>parenting without yelling</strong>.</li>
