    ...
    <div className="max-w-6xl mx-auto p-4 md:p-8" dir={isRTL ? 'rtl' : 'ltr'}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center justify-center text-center">
          ...
          <p className="text-base md:text-lg text-gray-600 mb-6 leading-relaxed max-w-md px-4 break-words w-full" style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>{t('pages.blog.components.multiplicationWorksheetsBlog.powerOfPracticeSubtitle')}</p>
          ...
          <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-md px-4 break-words w-full" style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>{t('pages.blog.components.multiplicationWorksheetsBlog.improvedRetentionText')}</p>
        </div>
