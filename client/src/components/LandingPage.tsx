  ...
  return (
    <div className="min-h-screen bg-slate-50 overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        {/* SVG Vector Artwork Background */}
        <div className="absolute inset-0 opacity-30">
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1600 900' className="w-full h-full">
        ...
        {/* Original Animated Background (kept as fallback - can be removed if you like the SVG) */}
