...
export const en = {
  ...
  home: {
    ...
    grades: {
      title: 'Free Worksheets for Every Grade: Multiplication, Addition, Subtraction & More',
      subtitle: 'Help your child excel with our free multiplication worksheets, 2nd grade worksheets, 1st grade worksheets, kindergarten worksheets, and more! Download printable PDFs instantly with answer keys. Perfect for building confidence and mastering essential skills - no sign-up required!',
      kindergarten: {
        title: 'Kindergarten Worksheets',
        description: 'Free printable kindergarten worksheets for early learners. Download PDF worksheets covering counting, number recognition, basic shapes, and simple addition. Perfect for building foundations with answer keys included.',
        cta: 'View Kindergarten Worksheets →',
      },
      firstGrade: {
        title: '1st Grade Worksheets',
        description: 'Free printable 1st grade worksheets covering addition, subtraction, number sense, ten frames, and skip counting. Perfect for building foundational skills with answer keys included. Download PDF worksheets instantly for classroom or home use.',
        cta: 'View 1st Grade Worksheets →',
      },
      secondGrade: {
        title: '2nd Grade Worksheets',
        description: 'Free 2nd grade worksheets featuring multiplication, division, place value, and word problems. Download printable PDFs with answer keys for instant practice. Perfect for mastering multiplication tables and building confidence.',
        cta: 'View 2nd Grade Worksheets →',
      },
      thirdGrade: {
        title: '3rd Grade Worksheets',
        description: 'Free 3rd grade worksheets covering advanced multiplication, fractions, division, and multi-step word problems. Printable PDF worksheets with answer keys for comprehensive practice. Perfect for building problem-solving skills.',
        cta: 'View 3rd Grade Worksheets →',
      },
      fourthGrade: {
        title: '4th Grade Worksheets',
        description: 'Free 4th grade worksheets covering multiplication, division, fractions, decimals, and geometry. Download printable PDFs with answer keys for comprehensive practice and skill building.',
        cta: 'View 4th Grade Worksheets →',
      },
      fifthGrade: {
        title: '5th Grade Worksheets',
        description: 'Free 5th grade worksheets covering advanced multiplication, division, fractions, decimals, and algebra basics. Download printable PDF worksheets with answer keys for comprehensive practice.',
  ...
  pages: {
    ...
    contact: {
      ...
      loveToHear: {
        ...
        description: 'Whether you have a question, found a bug, or want to suggest a new worksheet idea — drop us a message and we\'ll get back to you soon.',
      },
      form: {
      ...
      subjects: {
        general: 'General',
        suggestWorksheet: 'Suggest a Worksheet',
      ...
      email: {
        ...
        builtFor: 'Wizqo is built for learners like you.',
    ...
    blog: {
      title: 'Wizqo Blog',
      subtitle: 'Discover learning tips, educational guides, and success stories from our community of learners.',
      popularPosts: 'Popular posts',
      readMore: 'Read more',
      newsletter: {
        title: 'Stay Updated',
        description: 'Get the latest learning guides and AI insights delivered to your inbox.',
        placeholder: 'Enter your email',
        subscribe: 'Subscribe',
        subscribing: 'Subscribing...',
        success: 'Successfully Subscribed!',
        successDesc: 'You\'ll receive our latest learning guides and AI insights in your inbox.',
      ...
      components: {
        ...
        cognitiveSkillsBlog: {
          ...
          challengeTitle: 'The Cognitive Skills Challenge',
    ...
    handwriting: {
      title: 'Free Custom Name Tracing Generator',
      subtitle: 'Generate personalized name tracing and cursive writing worksheets in seconds. Perfect for kids learning handwriting. Download your custom PDF instantly for free.',
      mode: {
        letters: 'Letters',
        words: 'Words',
        sentences: 'Sentences',
      ...
      seo: {
        directAnswer: {
          title: 'How can you create personalized name tracing worksheets?',
          text: 'To create a personalized name tracing worksheet, simply type the name or words into our free generator, choose a specialized style like **Monoline** for clean lines, **Kids Cursive** for advanced 3rd-grade practice, or the fun **Bubble font** for coloring activities. Adjust the font size to fit your needs, then click "Download PDF" to get your custom practice sheet instantly.'
        },
        howTo: {
          title: 'Step-by-Step: Using the Name Tracing Generator',
          step1: 'Type Your Text: Enter the names, letters, or sentences you want to practice.',
          step2: 'Choose a Style: Select from **Monoline**, **Kids Cursive**, or **Bubble** font based on your learner’s level.',
          step3: 'Print or Save: Instantly download your high-quality PDF to start practicing fine motor skills.'
        },
        authority: {
    ...
    privacy: {
      ...
      section1: {
        title: '1. Who We Are',
        content: 'Wizqo is an educational platform that provides free printable worksheets and learning resources. This Privacy Policy explains how we collect, use, and safeguard your data while using our services.',
      },
      section2: {
        title: '2. Information We Collect',
        intro: 'We collect the following types of data:',
        item1: 'Personal Information: name, email address, learning preferences',
      ...
      section3: {
        ...
        item1: 'Personalize your learning experience',
    ...
    dashboard: {
      ...
      welcomeMessage: 'Sign in to see your learning progress.',
      signInToContinue: 'Sign In to Continue',
      title: 'My Learning Dashboard',
      description: 'Track your progress across your learning resources.',
      ...
      shareModalSubtitle1: 'Challenge complete •',
      ...
      shareText1: '🎉 I just completed my',
      shareText2: 'learning journey!',
      shareText3: '✅ Mastered',
      shareText4: 'fundamentals across all lessons',
      shareText5: '📚 Completed all',
      shareText6: 'daily modules',
      shareText7: '🚀 Ready for the next challenge!',
      shareText8: 'Learn better with Wizqo at',
      shareLinkedInTitle: '🎉 Completed',
      shareLinkedInTitle2: 'Challenge!',
      noPlansTitle: 'No Learning Plans Yet',
      noPlansMessage: 'Start your learning journey today!',
      ...
      confirmCleanup: 'This will delete all duplicate plans, keeping only the most recent one for each. Continue?',
      cleanUpDuplicates: 'Clean Up Duplicates',
      cannotDetermineType: 'Cannot determine type for this plan',
