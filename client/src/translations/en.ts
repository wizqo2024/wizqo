...
export const en = {
  common: {
    ...
    multiply: 'Multiply',
    divide: 'Divide',
    twoNegatives: 'two negatives',
    positiveAndNegative: 'positive and negative',
    twoPositives: 'two positives',
    negative: 'negative',
    positive: 'positive',
    addAbsoluteValues: 'Add absolute values',
    keepNegativeSign: 'keep negative sign',
    subtractAbsoluteValues: 'Subtract absolute values',
    keepSignOfLarger: 'keep sign of larger number',
    changeSubtractionToAddition: 'Change subtraction to addition',
    multiplyAbsoluteValues: 'Multiply absolute values',
    resultIs: 'Result is',
    because: 'because',
    oneNumberNegative: 'one number is negative',
    bothSameSign: 'both numbers have the same sign',
  ...
  worksheets: {
    ...
    time: {
      ...
      answerKey: {
        ...
        minute: 'minute',
        minutes: 'minutes',
        step1: 'Step 1: Add minutes:',
        step2: 'Step 2: Add hours:',
    ...
    rounding: {
      ...
      answerKey: {
        ...
        roundUp: 'Round up because',
        roundDown: 'Round down because',
        onesDigit: 'ones digit',
        tensDigit: 'tens digit',
        hundredsDigit: 'hundreds digit',
        lookAt: 'Look at the',
        sinceGreater: 'Since it\'s 5 or greater, round up',
        sinceLess: 'Since it\'s less than 5, round down',
    ...
    decimals: {
      ...
      answerKey: {
        problem: 'Problem',
        solution: 'Solution:',
        add: 'Add: {{num1}} + {{num2}} = {{answer}}. Line up decimal points and add each place value.',
        subtract: 'Subtract: {{num1}} - {{num2}} = {{answer}}. Line up decimal points and subtract each place value.',
        multiply: 'Multiply: {{num1}} × {{num2}} = {{answer}}. Multiply as whole numbers, then count total decimal places and place decimal point.',
        divide: 'Divide: {{num1}} ÷ {{num2}} = {{answer}}. Move decimal points to make divisor whole, then divide normally.',
      },
    },
    integers: {
    ...
    'mult-facts-6-12': {
      ...
      example: {
        ...
        problem: 'Problem:',
        problemText: '8 × 7 = ?',
        strategy1: 'Strategy 1 (Break it down):',
        strategy1Text: '8 × 7 = (5 × 7) + (3 × 7) = 35 + 21 = 56',
        strategy2: 'Strategy 2 (Use known facts):',
        strategy2Text: 'If you know 7 × 7 = 49, then 8 × 7 = 49 + 7 = 56',
        strategy3: 'Strategy 3 (Skip counting):',
        strategy3Text: 'Count by 8s seven times: 8, 16, 24, 32, 40, 48, 56',
        answer: 'Answer:',
        answerText: '56',
        tip: '💡 Tip: Double check your steps!',
      },
      challenge: {
        title: '🌟 Challenge Yourself (Optional):',
        items: [
          'Create your own multiplication problem using numbers 6-12',
          'Solve: 12 × 12 = ? (the biggest fact in this worksheet!)',
          'Time yourself: Can you complete all {count} problems in under 3 minutes?',
        ],
      },
      selfAssessment: {
        title: '📊 How did you do?',
    ...
    'skip-count-mult': {
      ...
      example: {
        title: '📚 Leap Frog Example:',
        problem: 'Problem:',
        patternText: '2, 4, __, 8, __, 12',
        step1: 'Step 1:',
        step1Text: 'Find the jump: 2 to 4 is +2. Skip count by 2s!',
        step2: 'Step 2:',
        step2Text: 'Fill in: 2, 4, 6, 8, 10, 12',
        step3: 'Step 3:',
        step3Text: 'This is 2 × 6 (six jumps of 2)',
        answer: 'Answer:',
        answerText: '2 × 6 = 12',
        tip: '💡 Tip: Each number in the skip count is a "multiple" of the starting number!',
      },
    },
    ...
    'mult-patterns': {
      ...
      description: 'Observe how the numbers change. Can you find the hidden rule? Patterns help us understand multiplication better.',
      learningObjectives: [
      ...
      example: {
        title: '📚 Example - Pattern Detective:',
        problem: 'Problem:',
        problemText: 'Find the rule for: 2, 4, 6, 8, ...',
        step1: 'Step 1:',
        step1Text: 'Look at the "jump" between numbers: 2 to 4 is +2, 4 to 6 is +2',
        step2: 'Step 2:',
        step2Text: 'The rule is: Add 2 each time (Multiples of 2)',
        answer: 'Answer:',
        answerText: 'The next number is 10!',
        tip: '💡 Tip: Multiplication is just adding the same number over and over!',
      },
    },
    ...
    'mult-word-problems': {
      ...
      learningObjectives: [
        ...
        'Improve reading comprehension for math problems',
        'Identify keywords for multiplication',
      ],
      parentTeacherTips: [
        'Underline key numbers and words (e.g., "each", "total")',
        'Draw a picture to visualize the groups',
    ...
    'mult-fact-families': {
      ...
      example: {
        title: '📚 Example - Fact Family for 3, 4, 12',
        problem: 'Problem:',
        problemText: 'Write the equations for 3, 4, 12',
        answer: 'Answer:',
        tip: '💡 Tip: The biggest number is always the product!',
      },
    },
    'mult-area-model': {
      ...
      learningObjectives: [
        'Multiply multi-digit numbers using area models',
        'Understand partial products',
        'Standardize the area model visualization',
      ],
      parentTeacherTips: [
        'Start with 2x1 before moving to 2x2',
        'Add the partial products at the end',
        'Draw the boxes to scale when possible',
      ],
      example: {
        title: '📚 Example - Area Model for 12 × 4',
        problem: 'Problem:',
        problemText: '12 × 4 = ?',
        step1: 'Step 1:',
        step1Text: 'Break 12 into 10 and 2',
        step2: 'Step 2:',
        step2Text: 'Multiply 10 × 4 = 40 and 2 × 4 = 8',
        step3: 'Step 3:',
        step3Text: 'Add the results: 40 + 8 = 48',
        answer: 'Answer:',
        answerText: '12 × 4 = 48',
        tip: '💡 Tip: Area models help you see how big numbers are multiplied!',
      },
    },
    'mult-arrays-models': {
      title: 'Multiplication Arrays & Models',
      description: 'See how numbers form perfect rows and columns! Use arrays to visual and solve multiplication problems.',
      learningObjectives: [
        'Understand multiplication as equal groups arranged in rows and columns',
        'Learn to write multiplication facts based on visual models',
        'Improve counting and grouping skills',
      ],
      parentTeacherTips: [
        'Encourage students to count rows first (horizontal) then columns (vertical)',
        'Point out that 3x4 is the same as 4x3 - just rotated!',
        'Ask them to identify arrays in the classroom (ceiling tiles, egg cartons)',
      ],
      example: {
        title: '📚 Example - Array Architect:',
        problem: 'Problem:',
        problemText: '4 × 5 = ?',
        step1: 'Step 1:',
        step1Text: 'Look at the array: 4 rows and 5 columns',
        step2: 'Step 2:',
        step2Text: 'Count by rows: 5, 10, 15, 20',
        step3: 'Step 3:',
        step3Text: 'Or count all boxes: 1, 2, 3... 20 boxes total',
        answer: 'Answer:',
        answerText: '20',
        tip: '💡 Tip: Double check your steps!',
      },
      extension: {
        title: '🚀 Rocket Challenge!',
        step1: '1. Draw a massive 10x10 array on your own paper.',
        step2: '2. Count how many boxes are in half of it (5x10).',
        step3: '3. Create a word problem that matches one of the arrays above.',
      },
    },

    'mult-arrays': {
      title: 'City Builder: Window Arrays',
      description: 'Count the rows and columns of windows to find the total product. Visualize multiplication with buildings!',
      learningObjectives: [
        'Understand multiplication as repeated addition',
      ...
      example: {
        title: '📚 Project: Building Windows',
        problem: 'Problem:',
        step1: 'Step 1:',
        step1Text: 'There are 3 rows and 4 columns',
        step2: 'Step 2:',
        step2Text: 'Multiplication fact: 3 × 4',
        answer: 'Answer:',
        answerText: '12 windows',
        tip: '💡 Tip: Think of it as 4 + 4 + 4 = 12',
      },
    },
    'mult-fact-fluency': {
  ...
  pages: {
    printables: {
      ...
      buildPackButton: 'Build My Pack',
    },
    fourthGrade: {
      title: '4th Grade Math Worksheets',
      subtitle: 'Comprehensive & Fun',
      ...
      whatsInsideDesc: 'Our 4th grade worksheets help students master multi-digit operations, fractions, and more.',
      categories: {
      ...
      exploreLinks: {
        thirdGrade: '3rd Grade Math',
        fifthGrade: '5th Grade Math',
        multiplication: 'Multiplication',
        timesTable: 'Times Tables',
        readingComprehension: 'Reading Comprehension',
      },
      faqs: 'Frequently Asked Questions',
      noWorksheets: 'No worksheets found in this category.',
      clearFilters: 'Clear Filters',
      filterByCategory: 'Filter by Category',
      buildPack: 'Build a Packet',
      buildPackDesc: 'Create a custom printable packet in seconds.',
      buildPackTime: '5 Minutes',
      buildPackAge: 'Grade 4',
      buildPackFocus: 'Math Skills',
      faq1Question: 'What math topics are covered in 4th grade?',
      faq1Answer: 'Topics include long division, multi-digit multiplication, fractions, decimals, and geometry.',
      faq2Question: 'Are these worksheets aligned with common core?',
      faq2Answer: 'Yes, they cover key 4th grade Common Core standards.',
      faq3Question: 'Do worksheets include answer keys?',
      faq3Answer: 'Yes, most worksheets come with answer keys.',
      faq4Question: 'Can I print these for my class?',
      faq4Answer: 'Absolutely! Teachers are welcome to print and use these in the classroom.',
      seoTitle: '4th Grade Math Worksheets - Free PDF Printables',
      seoDescription: 'Browse our collection of free 4th grade math worksheets. Printable PDFs for multiplication, division, fractions, and more.',
      seoKeywords: '4th grade math, grade 4 math worksheets, printable math worksheets, fractions, decimals, division',
    },
    fifthGrade: {
      title: '5th Grade Math Worksheets',
      ...
      clickToView: 'Click to view',
      whatsInside: 'What\'s Inside?',
      whatsInsideDesc: 'Our 5th grade worksheets are designed to challenge students and build a strong foundation for middle school math.',
      categories: {
      ...
      worksheets: {
        mult3x2Digit: { title: '3-Digit x 2-Digit Multiplication', description: 'Practice multiplying larger numbers.' },
        longDivisionMultidigit: { title: 'Long Division (Multi-Digit)', description: 'Master long division with multi-digit divisors.' },
        orderOfOperations: { title: 'Order of Operations (PEMDAS)', description: 'Solve expressions using the correct order of operations.' },
        powersOf10: { title: 'Powers of 10', description: 'Multiply and divide by powers of 10.' },
        roundingDecimals: { title: 'Rounding Decimals', description: 'Round decimals to the nearest whole number, tenth, or hundredth.' },
        estimatingSumsDifferences: { title: 'Estimating Sums & Differences', description: 'Estimate answers by rounding first.' },
        addingSubtractingMixedNumbers: { title: 'Adding & Subtracting Mixed Numbers', description: 'Practice operations with mixed numbers.' },
        multiplyingFractions: { title: 'Multiplying Fractions', description: 'Multiply fractions by whole numbers and other fractions.' },
        dividingFractions: { title: 'Dividing Fractions', description: 'Divide fractions by whole numbers.' },
        multiplyingDecimals: { title: 'Multiplying Decimals', description: 'Multiply decimals by whole numbers and other decimals.' },
        dividingDecimals: { title: 'Dividing Decimals', description: 'Divide decimals by whole numbers.' },
        fractionsDecimalsPercents: { title: 'Fractions, Decimals & Percents', description: 'Convert between fractions, decimals, and percents.' },
        comparingOrderingFractionsDecimals: { title: 'Comparing Fractions & Decimals', description: 'Compare and order fractions and decimals.' },
        evaluatingExpressions: { title: 'Evaluating Expressions', description: 'Evaluate algebraic expressions with variables.' },
        writingExpressions: { title: 'Writing Expressions', description: 'Write algebraic expressions from word phrases.' },
        solvingOneStepEquations: { title: 'Solving One-Step Equations', description: 'Solve simple equations with one variable.' },
        patternsRules: { title: 'Patterns & Rules', description: 'Identify patterns and find the rule.' },
        coordinateGraphing: { title: 'Coordinate Graphing', description: 'Plot points on a coordinate plane.' },
        volumeRectangularPrisms: { title: 'Volume of Rectangular Prisms', description: 'Calculate the volume of boxes and prisms.' },
        areaTrianglesParallelograms: { title: 'Area of Triangles & Parallelograms', description: 'Find the area of different shapes.' },
        classifyingShapes: { title: 'Classifying Shapes', description: 'Classify polygons and other shapes.' },
        nets3dShapes: { title: 'Nets of 3D Shapes', description: 'Identify 3D shapes from their nets.' },
        transformations5th: { title: 'Transformations', description: 'Translations, rotations, and reflections.' },
        multiStepWord5th: { title: 'Multi-Step Word Problems', description: 'Solve complex word problems with multiple steps.' },
        fractionWordProblems5th: { title: 'Fraction Word Problems', description: 'Solve word problems involving fractions.' },
        decimalWordProblems5th: { title: 'Decimal Word Problems', description: 'Solve word problems involving decimals.' },
        ratioProportionWordProblems: { title: 'Ratio & Proportion Word Problems', description: 'Solve problems using ratios and proportions.' },
        percentWordProblems: { title: 'Percent Word Problems', description: 'Solve problems involving percents.' },
        lineGraphs: { title: 'Line Graphs', description: 'Read and interpret line graphs.' },
        meanMedianModeRange: { title: 'Mean, Median, Mode & Range', description: 'Calculate statistical measures.' },
        stemLeafPlots: { title: 'Stem-and-Leaf Plots', description: 'Organize and interpret data.' },
        probability: { title: 'Probability', description: 'Calculate the probability of events.' },
      },
      sections: {
      ...
      buildPackDesc: 'Create a custom printable packet in seconds.',
      buildPackTime: '5 Minutes',
      buildPackAge: 'Grade 5',
      buildPackFocus: 'Math Skills',
      faq1Question: 'What math topics are covered in 5th grade?',
      faq1Answer: 'Topics include advanced operations, fractions, decimals, volume, graphing, and intro to algebra.',
      faq2Question: 'Are these worksheets aligned with common core?',
      faq2Answer: 'Yes, they cover key 5th grade Common Core standards.',
      faq3Question: 'Do worksheets include answer keys?',
      faq3Answer: 'Yes, most worksheets come with answer keys.',
      faq4Question: 'Can I print these for my class?',
      faq4Answer: 'Absolutely! Teachers are welcome to print and use these in the classroom.',
      seoTitle: '5th Grade Math Worksheets - Free PDF Printables',
      seoDescription: 'Browse our collection of free 5th grade math worksheets. Printable PDFs for multiplication, division, fractions, and more.',
      seoKeywords: '5th grade math, grade 5 math worksheets, printable math worksheets, fractions, decimals, algebra',
    },
    about: {
      title: 'About Wizqo',
    ...
    blog: {
      ...
      popularWorksheets: 'Popular worksheets',
      quickWorksheetLinks: 'Quick worksheet links',
      ...
      components: {
        multiplicationWorksheetsBlog: {
          gameChangerTitle: 'Why Worksheets Are a Game Changer',
          gameChangerText: 'For many learners, multiplication is where math starts to feel "serious." As numbers get bigger, confidence can drop. Printable worksheets turn this frustration into visible progress, building skill, structure, and self-confidence one page at a time. Unlike screens, they offer repetition without distraction and build visual memory. For teachers and parents looking to create unlimited unique practice sheets, our Interactive Worksheets Generator makes it easy to create new multiplication worksheets with answer keys in seconds.',
          powerOfPracticeTitle: 'The Power of Practice',
          powerOfPracticeSubtitle: 'The science of learning is clear: handwriting activates the brain differently and more effectively than typing or tapping.',
          improvedRetention: 'Improved Retention',
          improvedRetentionText: 'This is the boost learners get from writing answers by hand. Every solved page is a small victory that builds motivation and long-term memory.',
          boostRetentionTitle: 'How Printables Boost Retention',
          boostRetentionText: 'Worksheets are a powerful, evidence-based way to build long-term knowledge. Compared to passive learning, active writing and problem-solving create much stronger neural pathways.',
          boostRetentionChartNote: 'This chart shows average retention rates by learning method, highlighting why active practice is superior for mastery.',
          whatsInsideTitle: 'What\'s Inside the Worksheet Pack?',
          whatsInsideText: 'The free pack is designed to build skills progressively, from foundational knowledge to real-world application, with a mix of fun and focus. This chart depicts the relative difficulty of each worksheet type. Our Interactive Worksheets Generator creates multiplication worksheets that include arrays, word problems, and timed challenges — all with printable answer keys included.',
          whatsInsideNote: 'The pack also includes answer keys, fun themes, and visual guides to ensure learners feel supported and engaged.',
          frustrationToFocusTitle: 'From Frustration to Focus',
          frustrationToFocusText: 'A parent from Dubai shared their story, proving that the right materials can turn routine into reward and change a child\'s mindset about math.',
          parentQuote: '"My son hated multiplication drills until we tried these printable worksheets. The color-by-number pages made him laugh... now he finishes practice before I even ask!"',
          parentCite: '— A parent from Dubai',
          frustrationToFocusNote: 'This is the goal: turning the task into a choice by making learning feel rewarding.',
          learningProcessTitle: 'The 4-Step Learning Process',
          learningProcessText: 'Our worksheets follow a simple but effective pattern. Learners don\'t just guess; they connect math to meaning and build a strong foundation for fluency. Each step naturally builds on the previous one, creating a clear path from confusion to confidence.',
          step1: { number: '1.', title: 'Visualize', description: 'Group objects and count patterns.' },
          step2: { number: '2.', title: 'Understand', description: 'See math as "adding equal groups."' },
          step3: { number: '3.', title: 'Apply', description: 'Solve fun real-world word problems.' },
          step4: { number: '4.', title: 'Recall', description: 'Practice timed drills for fluency.' },
          downloadTitle: 'Download Free Printable Worksheets',
          downloadText: 'Ready to get started? Get your free pack designed for learning, confidence, and fun. Use our Interactive Worksheets Generator to create unlimited unique multiplication worksheets with answer keys — perfect for classrooms, homework, or extra practice.',
          generateButton: 'Generate Free Worksheets Now',
          feature1: 'No sign-up required',
          feature2: 'Classroom & home use',
          feature3: 'Reusable & shareable',
          chartLabels: {
            ...
            difficultyRating: 'Difficulty Rating (out of 3)',
            basicTimesTables: 'Basic Times Tables 1–5',
            colorByNumber: 'Color-by-Number Pages',
            doubleDigit: 'Double-Digit Practice',
            wordProblems: 'Word Problem Sheets',
            timedChallenges: 'Timed Challenges',
          },
        },
        cognitiveSkillsBlog: {
          headerTitle: '🧠 What Are Cognitive Skills? How to Strengthen Your Mind and Unlock Your True Potential',
          headerQuote: '"The mind is not a vessel to be filled, but a fire to be kindled."',
          headerDescription: 'Discover how cognitive skills shape focus, memory, and confidence — plus free printable brain games and a 7-day challenge to help you think sharper and feel stronger.',
          coreSkillsTitle: 'The 5 Core Cognitive Skills',
          coreSkillsDescription: 'These five skills work together to help you learn, solve problems, and think clearly. When you strengthen one, you boost them all.',
          chartLabel: 'Cognitive Skills',
          chartLabels: {
            attention: 'Attention',
          ...
          attention: {
            title: 'Attention',
            description: 'Your ability to focus on what matters and ignore distractions. Strong attention helps you stay on task, follow directions, and complete work without getting sidetracked.',
            improve: 'Improve with: puzzles, spot-the-difference games, and focused reading practice.',
          },
          logicReasoning: {
            title: 'Logic & Reasoning',
            description: 'How you solve problems, make connections, and think through challenges step-by-step. This skill helps you understand cause and effect, see patterns, and make smart decisions.',
            improve: 'Improve with: math puzzles, word problems, and logic grid exercises.',
          },
          memory: {
            title: 'Memory',
            description: 'Your ability to store and recall information. Working memory holds information temporarily (like phone numbers), while long-term memory stores facts and experiences for later.',
            improve: 'Improve with: memory games, repetition practice, and storytelling activities.',
          },
          processingSpeed: {
            title: 'Processing Speed',
            description: 'How quickly you can take in, understand, and respond to information. Faster processing helps you keep up in conversations, complete tasks efficiently, and feel more confident.',
            improve: 'Improve with: timed math drills, quick decision games, and rapid reading practice.',
          },
          visualProcessing: {
            title: 'Visual Processing',
            description: 'How your brain makes sense of what you see. This includes recognizing shapes, understanding spatial relationships, and noticing details in images or text.',
            improve: 'Improve with: pattern matching, visual puzzles, and drawing exercises.',
          },
          proofTitle: 'Real Results: Before & After',
          proofDescription: 'See how strengthening cognitive skills transforms learning and confidence.',
          beforeTitle: 'Before',
          beforeItems: [
          ...
          scienceTitle: 'The Science: Why Cognitive Skills Matter',
          scienceDescription: 'Research shows that targeted cognitive skill training can improve academic performance, boost confidence, and reduce learning anxiety. A 2023 study found that students who practiced cognitive exercises for just 10 minutes a day saw significant improvements in focus, memory, and problem-solving within 6 weeks.',
          scienceQuote: '"Cognitive skills are the foundation of all learning. When we strengthen them, we unlock potential that was always there — we just needed the right tools to access it."',
          challengeTitle: 'The 7-Day Cognitive Skills Challenge',
          challengeDescription: 'Try this simple daily routine to strengthen all five cognitive skills. Each day focuses on a different skill, but they all work together to build a stronger mind.',
          monday: {
            day: 'Monday',
            activity: 'Puzzle Power: Complete a spot-the-difference or pattern puzzle (10 minutes)',
          },
          tuesday: {
            day: 'Tuesday',
            activity: 'Brain Training: Practice memory games or recall exercises (10 minutes)',
          },
          wednesday: {
            day: 'Wednesday',
            activity: 'Math Mind: Solve 5 logic or word problems (10 minutes)',
          },
          thursday: {
            day: 'Thursday',
            activity: 'Reading Focus: Read a short passage and answer detail questions (10 minutes)',
          },
          friday: {
            day: 'Friday',
            activity: 'Visual Skills: Complete a visual pattern or drawing exercise (10 minutes)',
          },
          saturday: {
            day: 'Saturday',
            activity: 'Speed Practice: Timed math drills or quick decision games (10 minutes)',
          },
          sunday: {
            day: 'Sunday',
            activity: 'Mix & Match: Combine any 2 activities from the week (15 minutes)',
          },
          footerTitle: '💖 Remember: Progress, Not Perfection',
          footerDescription: 'Building cognitive strength isn\'t about doing everything perfectly. It\'s about showing up — one small step, one puzzle, one worksheet at a time.',
          footerQuote: '"Small progress is still progress. And progress builds confidence."',
          footerLink: 'Ready to strengthen your cognitive skills? Explore our free interactive worksheets →',
        },
        gentleParentingFull: {
          headerTitle: 'Gentle Parenting Techniques That Actually Work — Real Stories, Science, and Simple Wins',
          headerSubtitle: 'Because parenting isn\'t about perfection — it\'s about connection.',
          tocTitle: 'Table of Contents',
          tocItems: {
            whatIs: 'What Is Gentle Parenting?',
            science: 'The Science: Connection Before Correction',
            techniques: '5 Techniques That Work',
            impact: 'Impact: By the Numbers',
            myths: 'Common Myths vs. Reality',
            startToday: 'You Can Start Today',
          },
          whatIsTitle: 'What Is Gentle Parenting?',
          whatIsText1: 'The goal of mindful parenting is not a "perfect" child. By applying gentle parenting techniques, you build a calmer, more connected relationship.',
          whatIsText2: 'At its heart, it means:',
          respect: 'Respect',
          respectOver: 'over fear.',
          guidance: 'Guidance',
          guidanceOver: 'over punishment.',
          empathy: 'Empathy',
          empathyOver: 'over control.',
          whatIsText3: 'It\'s not about letting kids "get away" with things. It\'s about teaching emotional intelligence and problem‑solving in real time.',
          studyTitle: 'Study: Impact on Child Cooperation',
          studyText: 'A 2023 APA study found parents shifting to gentle techniques saw a 60% improvement in cooperation vs. traditional methods.',
          scienceTitle: 'The Science: Connection Before Correction',
          scienceText: 'A child\'s "downstairs brain" (emotions) often overrides the "upstairs brain" (logic) when upset. Connection calms first; then correction teaches.',
          upstairsBrain: '🧠 Upstairs Brain',
          upstairsBrainDesc: '(Logic, Reasoning, Control)',
          downstairsBrain: '❤️ Downstairs Brain',
          downstairsBrainDesc: '(Emotions, Instincts, Tantrums)',
          connectionFirst: 'Connection first. Cooperation next.',
          realLifeExample: 'Real-Life Example:',
          realLifeStory: 'When 7‑year‑old Mia refused to put on her shoes, instead of yelling, her mom knelt and said:',
          realLifeQuote: '"You really don\'t want to stop playing, right? It\'s hard to leave something fun."',
          realLifeResult: 'Mia nodded, took a deep breath — and then slipped on her shoes.',
          techniquesTitle: '5 Gentle Parenting Techniques That Work',
          technique1: {
            title: 'Pause Before Reacting',
            description: 'Even 5 seconds can reset your tone. Using gentle parenting techniques models calm discipline — a vital skill.',
          },
          technique2: {
            title: 'Name the Emotion',
            description: '"You\'re mad because your tower fell." Empathy lowers defenses; kids who feel seen listen better.',
          },
          technique3: {
            title: 'Offer Choices, Not Orders',
            description: '"Blocks or books first?" Choices reduce power struggles — a mindful parenting win.',
          },
          technique4: {
            title: 'Repair After Conflict',
            description: '"I\'m sorry I yelled." Repair teaches accountability and that relationships can be fixed.',
          },
          technique5: {
            title: 'Set Boundaries with Love',
            description: '"I won\'t let you hit, but I will help you calm down." Firm limits with warmth build trust.',
          },
          impactTitle: 'The Real‑World Impact: By the Numbers',
          impactText: 'Gentle parenting techniques are backed by science. They reduce stress hormones and improve connected cooperation over time.',
          stat1Title: '42% Fewer Tantrums',
          stat1Subtitle: 'Reported after 30 days.',
          stat2Title: '3x',
          stat2Subtitle: 'Better Emotional Vocabulary',
          stat2Description: 'In kids aged 3–8.',
          stat3Title: '60% Higher Cooperation',
          stat3Subtitle: 'From improved connection.',
          trackingTitle: 'Tracking Progress: Tantrum Reduction Over Time',
          mythsTitle: 'Common Myths vs. Reality',
          myth1: '"It\'s too soft."',
          reality1: 'It\'s firm and consistent — just without fear tactics. This is the foundation of effective gentle parenting techniques.',
          mythLabel: 'Myth',
          realityLabel: 'Reality',
          myth2: '"Kids won\'t respect you."',
          reality2: 'Respect is modeled, not demanded. Calm, respectful parents model the behavior they want to see.',
          myth3: '"It takes too long."',
          reality3: 'It\'s an investment: fewer battles now, more self‑discipline later.',
          startTodayTitle: 'You Can Start Today',
          startTodayText: 'Nobody\'s perfect. The beauty of gentle parenting is you can start today, even after tough moments. You\'re not raising a "good" kid — you\'re raising a kind, emotionally aware human.',
          startSmallTitle: 'Start Small:',
          tip1: 'Take one deep breath before reacting, a step toward parenting without yelling.',
          tip2: 'Listen more than you lecture.',
          tip3: 'Validate feelings: "You\'re sad it\'s bedtime, huh?"',
          tip4: 'Hug after hard moments.',
          progressOver: '🌟 Progress over perfection.',
          connectionOver: 'Connection over control.',
          exploreTitle: 'Motivate your child with these activities',
          chartLabels: {
            traditionalDiscipline: 'Traditional Discipline',
            gentleParenting: 'Gentle Parenting',
            cooperationRate: 'Cooperation Rate (%)',
            tantrumsReduced: 'Tantrums Reduced',
            remainingBaseline: 'Remaining Baseline',
            cooperationGained: 'Cooperation Gained',
            baseline: 'Baseline',
            weeklyTantrumIncidents: 'Weekly Tantrum Incidents',
            avgTantrumIncidents: 'Avg. Tantrum Incidents',
            weeksApplyingTechniques: 'Weeks Applying Techniques',
            week0: 'Week 0',
            week1: 'Week 1',
            week2: 'Week 2',
            week3: 'Week 3',
    ...
    interactive: {
      ...
      customization: {
        description: 'Add student names, teacher name, and class name to personalize your worksheets before downloading.',
        teacherName: 'Teacher Name',
        teacherNamePlaceholder: 'Enter teacher name',
        className: 'Class Name',
        classNamePlaceholder: 'Enter class name (e.g., Grade 3A)',
        studentNames: 'Student Names',
        addStudent: 'Add Student',
        removeStudent: 'Remove student',
      },
      closePreview: 'Close preview',
      copyLinkManually: 'Unable to copy link. Please copy manually:',
      pleaseCopyLink: 'Please copy this link:',
