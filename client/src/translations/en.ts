...
export const en = {
  ...
  pages: {
    ...
    timesTable: {
      title: 'Free Times Table Worksheets PDF',
      subtitle: 'Print free time table multiplication worksheets (PDF) that boost confidence, speed, and accuracy. Fun, no-stress practice sheets for grades 1–5.',
    },
    certificate: {
