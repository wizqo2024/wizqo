  ...
  const interactiveKeys = {
    en: {
      ...
      cognitiveFlexibility: {
        ...
        switchNewRule: 'Switch! New rule:',
        situation: 'Situation:',
        yourPerspective: 'Your perspective:',
        anotherPerspective: 'Another perspective:',
        tasks: {
          sortByColor: 'Sort by color',
          groupRedItems: 'Group red items together',
          sortBySize: 'Now sort by size instead',
          countForward: 'Count forward',
          count123: 'Count 1, 2, 3...',
          countBackward: 'Now count backward from 10',
          nameAnimals: 'Name animals',
          listFarmAnimals: 'List farm animals',
          listOceanAnimals: 'Now list ocean animals',
        },
        perspectives: {
          newStudent: 'A new student joins your class',
          gameCancelled: 'Your favorite game is cancelled',
          disagreeWith: 'You have to work with someone you disagree with',
        },
        solutionForBoth: 'What\'s a solution that works for both?',
      },
      cognitiveProcessing: {
    ...
    es: {
      ...
      cognitiveFlexibility: {
        ...
        firstRule: 'Primera regla:',
        switchNewRule: '¡Cambia! Nueva regla:',
        situation: 'Situación:',
        yourPerspective: 'Tu perspectiva:',
        anotherPerspective: 'Otra perspectiva:',
        tasks: {
          sortByColor: 'Ordenar por color',
          groupRedItems: 'Agrupa los elementos rojos juntos',
          sortBySize: 'Ahora ordena por tamaño en su lugar',
          countForward: 'Contar hacia adelante',
          count123: 'Cuenta 1, 2, 3...',
          countBackward: 'Ahora cuenta hacia atrás desde 10',
          nameAnimals: 'Nombrar animales',
          listFarmAnimals: 'Lista animales de granja',
          listOceanAnimals: 'Ahora lista animales del océano',
        },
        perspectives: {
          newStudent: 'Un nuevo estudiante se une a tu clase',
          gameCancelled: 'Tu juego favorito se cancela',
          disagreeWith: 'Tienes que trabajar con alguien con quien no estás de acuerdo',
        },
        solutionForBoth: '¿Cuál es una solución que funcione para ambos?',
      },
      cognitiveProcessing: {
    ...
    ar: {
      ...
      cognitiveFlexibility: {
        ...
        firstRule: 'القاعدة الأولى:',
        switchNewRule: 'تبديل! قاعدة جديدة:',
        situation: 'الموقف:',
        yourPerspective: 'وجهة نظرك:',
        anotherPerspective: 'وجهة نظر أخرى:',
        tasks: {
          sortByColor: 'ترتيب حسب اللون',
          groupRedItems: 'اجمع العناصر الحمراء معاً',
          sortBySize: 'الآن رتب حسب الحجم بدلاً من ذلك',
          countForward: 'عد للأمام',
          count123: 'عد 1، 2، 3...',
          countBackward: 'الآن عد للخلف من 10',
          nameAnimals: 'تسمية الحيوانات',
          listFarmAnimals: 'اذكر حيوانات المزرعة',
          listOceanAnimals: 'الآن اذكر حيوانات المحيط',
        },
        perspectives: {
          newStudent: 'ينضم طالب جديد إلى صفك',
          gameCancelled: 'تم إلغاء لعبتك المفضلة',
          disagreeWith: 'يجب أن تعمل مع شخص لا تتفق معه',
        },
        solutionForBoth: 'ما الحل الذي يناسب كليهما؟',
      },
      cognitiveProcessing: {
