        ...
        try {
            ...
            const canvas = await html2canvas(printRef.current, {
                ...
                onclone: (clonedDoc: Document) => {
                    // Find the main worksheet div in the cloned document
                    const clonedWorksheet = clonedDoc.querySelector('[ref="printRef"]') || clonedDoc.body.querySelector('div > div > div:nth-child(2) > div') as HTMLElement

                    // Fallback to the largest visible div if selector fails
