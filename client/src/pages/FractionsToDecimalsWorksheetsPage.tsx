...
export default function FractionsToDecimalsWorksheetsPage() {
  ...
  const allWorksheets: WorksheetItem[] = useMemo(() => [
    ...
    { title: t('pages.fractionsToDecimals.worksheets.basicTenths.title'), description: t('pages.fractionsToDecimals.worksheets.basicTenths.description'), href: '/print?doc=fractions-to-decimals&from=fractions-to-decimals', docId: 'fractions-to-decimals-basic-tenths', categories: ['basic', 'tenths-hundredths'], gradeRange: '3rd' },
    { title: t('pages.fractionsToDecimals.worksheets.visualTenths.title'), description: t('pages.fractionsToDecimals.worksheets.visualTenths.description'), href: '/print?doc=decimals-place-value&from=fractions-to-decimals', docId: 'decimals-place-value', categories: ['visual', 'tenths-hundredths'], gradeRange: '3rd' },
    ...
    { title: t('pages.fractionsToDecimals.worksheets.divisionMethod.title'), description: t('pages.fractionsToDecimals.worksheets.divisionMethod.description'), href: '/print?doc=fractions-to-decimals&from=fractions-to-decimals', docId: 'fractions-to-decimals-division', categories: ['division'], gradeRange: '4th' },
    ...
    { title: t('pages.fractionsToDecimals.worksheets.orderingFractionsDecimals.title'), description: t('pages.fractionsToDecimals.worksheets.orderingFractionsDecimals.description'), href: '/print?doc=comparing-ordering-fractions-decimals&from=fractions-to-decimals', docId: 'ordering-fractions-decimals', categories: ['comparing'], gradeRange: '5th' },
    { title: t('pages.fractionsToDecimals.worksheets.percentConversions.title'), description: t('pages.fractionsToDecimals.worksheets.percentConversions.description'), href: '/print?doc=fractions-decimals-percents&from=fractions-to-decimals', docId: 'fractions-decimals-percents', categories: ['percentage'], gradeRange: '5th' },
    { title: t('pages.fractionsToDecimals.worksheets.percentWordProblems.title'), description: t('pages.fractionsToDecimals.worksheets.percentWordProblems.description'), href: '/print?doc=percent-word-problems&from=fractions-to-decimals', docId: 'percent-word-problems', categories: ['word-problems', 'percentage'], gradeRange: '5th' },
    ...
    { title: t('pages.fractionsToDecimals.worksheets.percentToDecimal.title'), description: t('pages.fractionsToDecimals.worksheets.percentToDecimal.description'), href: '/print?doc=fractions-decimals-percents&from=fractions-to-decimals', docId: 'percent-to-decimal', categories: ['percentage'], gradeRange: '5th' },
    { title: t('pages.fractionsToDecimals.worksheets.decimalToPercent.title'), description: t('pages.fractionsToDecimals.worksheets.decimalToPercent.description'), href: '/print?doc=fractions-decimals-percents&from=fractions-to-decimals', docId: 'decimal-to-percent', categories: ['percentage'], gradeRange: '5th' },
