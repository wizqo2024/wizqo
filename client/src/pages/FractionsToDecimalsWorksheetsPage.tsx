...
export default function FractionsToDecimalsWorksheetsPage() {
  ...
  const allWorksheets: WorksheetItem[] = useMemo(() => [
    ...
    { title: t('pages.fractionsToDecimals.worksheets.orderingFractionsDecimals.title'), description: t('pages.fractionsToDecimals.worksheets.orderingFractionsDecimals.description'), href: '/print?doc=comparing-ordering-fractions-decimals&from=fractions-to-decimals', docId: 'comparing-ordering-fractions-decimals', categories: ['comparing'], gradeRange: '5th' },
    ...
    { title: t('pages.fractionsToDecimals.worksheets.fractionsOutOf100.title'), description: t('pages.fractionsToDecimals.worksheets.fractionsOutOf100.description'), href: '/print?doc=fractions-decimals-percents&from=fractions-to-decimals', docId: 'fractions-decimals-percents', categories: ['percentage', 'tenths-hundredths'], gradeRange: '4th' },
    { title: t('pages.fractionsToDecimals.worksheets.percentToDecimal.title'), description: t('pages.fractionsToDecimals.worksheets.percentToDecimal.description'), href: '/print?doc=fractions-decimals-percents&from=fractions-to-decimals', docId: 'fractions-decimals-percents', categories: ['percentage'], gradeRange: '5th' },
    { title: t('pages.fractionsToDecimals.worksheets.decimalToPercent.title'), description: t('pages.fractionsToDecimals.worksheets.decimalToPercent.description'), href: '/print?doc=fractions-decimals-percents&from=fractions-to-decimals', docId: 'fractions-decimals-percents', categories: ['percentage'], gradeRange: '5th' },
