...
export default function FractionsToDecimalsWorksheetsPage() {
  ...
  const allWorksheets: WorksheetItem[] = useMemo(() => [
    // 3rd Grade
    { title: t('pages.fractionsToDecimals.worksheets.basicTenths.title'), description: t('pages.fractionsToDecimals.worksheets.basicTenths.description'), href: '/print?doc=fractions-to-decimals-tenths&from=fractions-to-decimals', docId: 'fractions-to-decimals-tenths', categories: ['basic', 'tenths-hundredths'], gradeRange: '3rd' },
    { title: t('pages.fractionsToDecimals.worksheets.visualTenths.title'), description: t('pages.fractionsToDecimals.worksheets.visualTenths.description'), href: '/print?doc=fractions-to-decimals-visual-tenths&from=fractions-to-decimals', docId: 'fractions-to-decimals-visual-tenths', categories: ['visual', 'tenths-hundredths'], gradeRange: '3rd' },
    { title: t('pages.fractionsToDecimals.worksheets.basicHundredths.title'), description: t('pages.fractionsToDecimals.worksheets.basicHundredths.description'), href: '/print?doc=fractions-to-decimals-hundredths&from=fractions-to-decimals', docId: 'fractions-to-decimals-hundredths', categories: ['basic', 'tenths-hundredths'], gradeRange: '3rd' },
    // 4th Grade
    { title: t('pages.fractionsToDecimals.worksheets.mixedNumbersBasic.title'), description: t('pages.fractionsToDecimals.worksheets.mixedNumbersBasic.description'), href: '/print?doc=fractions-to-decimals-mixed-basic&from=fractions-to-decimals', docId: 'fractions-to-decimals-mixed-basic', categories: ['mixed-numbers'], gradeRange: '4th' },
    { title: t('pages.fractionsToDecimals.worksheets.comparingFractionsDecimals.title'), description: t('pages.fractionsToDecimals.worksheets.comparingFractionsDecimals.description'), href: '/print?doc=fractions-to-decimals-comparing&from=fractions-to-decimals', docId: 'fractions-to-decimals-comparing', categories: ['comparing'], gradeRange: '4th' },
    { title: t('pages.fractionsToDecimals.worksheets.divisionMethod.title'), description: t('pages.fractionsToDecimals.worksheets.divisionMethod.description'), href: '/print?doc=fractions-to-decimals-division&from=fractions-to-decimals', docId: 'fractions-to-decimals-division', categories: ['division'], gradeRange: '4th' },
    { title: t('pages.fractionsToDecimals.worksheets.wordProblemsBasic.title'), description: t('pages.fractionsToDecimals.worksheets.wordProblemsBasic.description'), href: '/print?doc=fractions-to-decimals-word-problems&from=fractions-to-decimals', docId: 'fractions-to-decimals-word-problems', categories: ['word-problems'], gradeRange: '4th' },
    // 5th Grade
    { title: t('pages.fractionsToDecimals.worksheets.advancedMixedNumbers.title'), description: t('pages.fractionsToDecimals.worksheets.advancedMixedNumbers.description'), href: '/print?doc=fractions-to-decimals-mixed-advanced&from=fractions-to-decimals', docId: 'fractions-to-decimals-mixed-advanced', categories: ['mixed-numbers'], gradeRange: '5th' },
    { title: t('pages.fractionsToDecimals.worksheets.repeatingDecimals.title'), description: t('pages.fractionsToDecimals.worksheets.repeatingDecimals.description'), href: '/print?doc=fractions-to-decimals-repeating&from=fractions-to-decimals', docId: 'fractions-to-decimals-repeating', categories: ['division'], gradeRange: '5th' },
    { title: t('pages.fractionsToDecimals.worksheets.complexWordProblems.title'), description: t('pages.fractionsToDecimals.worksheets.complexWordProblems.description'), href: '/print?doc=fractions-to-decimals-word-problems-advanced&from=fractions-to-decimals', docId: 'fractions-to-decimals-word-problems-advanced', categories: ['word-problems'], gradeRange: '5th' },
    { title: t('pages.fractionsToDecimals.worksheets.orderingFractionsDecimals.title'), description: t('pages.fractionsToDecimals.worksheets.orderingFractionsDecimals.description'), href: '/print?doc=fractions-to-decimals-ordering&from=fractions-to-decimals', docId: 'fractions-to-decimals-ordering', categories: ['comparing'], gradeRange: '5th' },
    // All Grades - Practice
    { title: t('pages.fractionsToDecimals.worksheets.mixedReview.title'), description: t('pages.fractionsToDecimals.worksheets.mixedReview.description'), href: '/print?doc=fractions-to-decimals-mixed-review&from=fractions-to-decimals', docId: 'fractions-to-decimals-mixed-review', categories: ['basic'], gradeRange: 'All' },
    { title: t('pages.fractionsToDecimals.worksheets.fluencyPractice.title'), description: t('pages.fractionsToDecimals.worksheets.fluencyPractice.description'), href: '/print?doc=fractions-to-decimals-fluency&from=fractions-to-decimals', docId: 'fractions-to-decimals-fluency', categories: ['basic'], gradeRange: 'All' },
  ], [t])
