    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          {/* Left: Controls */}
          <div className="order-2 md:order-1 bg-white border border-slate-200 rounded-2xl p-4 shadow-sm w-full md:max-w-md whitespace-normal">
            ...
            {/* Right: Preview */}
            <div className="order-1 md:order-2 md:sticky md:top-20 w-full min-w-0 md:justify-self-end" id="handwriting-preview">
