        ...
        {allPosts.length > 0 ? (
          <div className="space-y-8">
            ...
            >
              ...
              {(() => {
                const feature = featurePost || allPosts[0];
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-4 mb-4 sm:mb-6 text-sm">
                <span className="flex items-center gap-2">
                  ...
                  {(featurePost || allPosts[0]).readTime}
                </span>
                <span className="flex items-center gap-2">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                  </svg>
                  {(featurePost || allPosts[0]).date}
                </span>
                <span className="bg-white bg-opacity-20 px-2 py-1 rounded text-xs">
                  {(featurePost || allPosts[0]).category}
                </span>
                <div className="flex items-center gap-1 text-yellow-300">
                  ...
                  <span className="text-sm ml-1">({getPostRating((featurePost || allPosts[0]))})</span>
                </div>
              </div>
            </article>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {allPosts.filter(p => (featurePost ? p.id !== featurePost.id : true)).map((post) => (
                  <article 
                    key={post.id}
