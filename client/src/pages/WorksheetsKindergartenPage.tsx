...
export default function WorksheetsKindergartenPage() {
  ...
  const KINDERGARTEN_WORKSHEETS: WorksheetItem[] = useMemo(() => [
    // Counting
    { title: '🔢 Counting 1–10', description: 'Count the objects in each group. Write the number in the box.', href: '/print?doc=kindergarten-counting-1-10&from=kindergarten', docId: 'kindergarten-counting-1-10', categories: ['counting'], section: 'Counting' },
    { title: '🐻 Counting with Cute Characters', description: 'Count the cute cartoon characters in each group. Write the number in the box.', href: '/print?doc=kindergarten-counting-visual&from=kindergarten', docId: 'kindergarten-counting-visual', categories: ['counting'], section: 'Counting' },
    ...
    { title: '➕ Addition with Pictures', description: 'Count the objects in each group. Add them together and write the answer.', href: '/print?doc=kindergarten-addition-pictures&from=kindergarten', docId: 'kindergarten-addition-pictures', categories: ['counting'], section: 'Counting' },
    // Number Recognition
    { title: '🔢 Number Recognition', description: 'Match each number to the group with the same amount. Draw a line to connect them.', href: '/print?doc=kindergarten-number-recognition&from=kindergarten', docId: 'kindergarten-number-recognition', categories: ['number-recognition'], section: 'Number Recognition' },
    ...
    // Shapes & Colors
    { title: '🔷 Shapes', description: 'Color each shape according to the instructions. Say the shape name out loud.', href: '/print?doc=kindergarten-shapes&from=kindergarten', docId: 'kindergarten-shapes', categories: ['shapes-colors'], section: 'Shapes & Colors' },
    ...
    // Patterns
    { title: '🔁 Patterns', description: 'Complete each pattern. Look at what comes before and continue the pattern.', href: '/print?doc=kindergarten-patterns&from=kindergarten', docId: 'kindergarten-patterns', categories: ['patterns'], section: 'Patterns' },
