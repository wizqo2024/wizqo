...
export default function WorksheetsKindergartenPage() {
  ...
  const KINDERGARTEN_WORKSHEETS: WorksheetItem[] = useMemo(() => [
    ...
    { title: '🌑 Match Object to Shadow', description: 'Draw a line to connect each object to its matching shadow. Great for visual perception!', href: getWorksheetURL('match-object-to-shadow', 'kindergarten'), docId: 'match-object-to-shadow', categories: ['shapes-colors'], section: 'Shapes & Colors' },
    { title: '😊 Match the Feeling', description: 'Identify emotions! Match feelings like sad, happy, and bored to real-life situations.', href: getWorksheetURL('match-the-feeling', 'kindergarten'), docId: 'match-the-feeling', categories: ['shapes-colors'], section: 'Shapes & Colors' },
    // Patterns
