...
export default function WorksheetsKindergartenPage() {
  ...
  const KINDERGARTEN_WORKSHEETS: WorksheetItem[] = useMemo(() => [
    // Counting
    { title: '🔢 Counting 1–10', description: 'Count the objects in each group. Write the number in the box.', href: getWorksheetURL('kindergarten-counting-1-10', 'kindergarten'), docId: 'kindergarten-counting-1-10', categories: ['counting'], section: 'Counting' },
    { title: '🐻 Counting with Cute Characters', description: 'Count the cute cartoon characters in each group. Write the number in the box.', href: getWorksheetURL('kindergarten-counting-visual', 'kindergarten'), docId: 'kindergarten-counting-visual', categories: ['counting'], section: 'Counting' },
    ...
    { title: '➕ Addition with Pictures', description: 'Count the objects in each group. Add them together and write the answer.', href: getWorksheetURL('kindergarten-addition-pictures', 'kindergarten'), docId: 'kindergarten-addition-pictures', categories: ['counting'], section: 'Counting' },
    // Number Recognition
    { title: '🔢 Number Recognition', description: 'Match each number to the group with the same amount. Draw a line to connect them.', href: getWorksheetURL('kindergarten-number-recognition', 'kindergarten'), docId: 'kindergarten-number-recognition', categories: ['number-recognition'], section: 'Number Recognition' },
    ...
    // Shapes & Colors
    { title: '🔷 Shapes', description: 'Color each shape according to the instructions. Say the shape name out loud.', href: getWorksheetURL('kindergarten-shapes', 'kindergarten'), docId: 'kindergarten-shapes', categories: ['shapes-colors'], section: 'Shapes & Colors' },
    ...
    // Pre-Writing
    { title: t('pages.grades.kindergarten.worksheets.lineTracing.title'), description: t('pages.grades.kindergarten.worksheets.lineTracing.description'), href: getWorksheetURL('line-tracing', 'kindergarten'), docId: 'line-tracing', categories: ['pre-writing'], section: 'Pre-Writing' },
