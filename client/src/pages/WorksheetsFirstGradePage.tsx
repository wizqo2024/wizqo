      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
        ...
        <section>
          ...
          <div className="mt-4 border border-slate-200 rounded-xl p-4 bg-white">
            ...
            <a href="/print?doc=pack&time=5&age=k2&skill=math" className="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-purple-600 text-white hover:bg-purple-700 transition-colors">Build Pack →</a>
          </div>
        </section>
