...
import { MoreLessEqual10, TenFrames1To10, Sub2Digit100, AdditionSubtraction0To10, NumberTracing1To20 } from './printables/MathWorksheets'
import { Add2DigitRegrouping, Sub2DigitRegrouping, EvenOdd100, Compare2Digit, FractionsHalvesThirdsFourths, SkipCounting5To120, MissingNumbers50, Time5Min, ExpandedForm200, NumberPatterns200, RoundingNearest10, AddThreeNumbers, MissingAddends, FactFamilies20, MentalMath20, DoublesNearDoubles, NumberLine200, MoneyCoinsBills, MeasurementLength, BarGraphsData, Add2Digit100 } from './printables/SecondGradeMath'
import {
  MultiplicationFacts,
...
import { NumberLineAddition, SkipCountingWorksheet, BalanceEquations, SubtractionStories, NumberBonds10, CountWrite30, MissingNumbers50 as MissingNumbers50FirstGrade, DoublesFacts, PictureAddition10, CountingObjects20, MoreLessEqual10 as MoreLessEqual10FG } from './printables/FirstGradeMathWorksheets'
...
import { GratitudeJar, MoodTracker, WeeklyGoals, Mandalas, FeelingsCheckin, RewardChart } from './printables/SocialEmotionalWorksheets'
...
import { WordSearch } from './worksheets/WordSearch'
import { Sudoku } from './worksheets/Sudoku'
    ...
    <div className="min-h-screen bg-white" data-worksheet-content="true" data-doc={doc || primaryDoc || ''}>
      ...
      <div className={`max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 print:p-0 print:py-0 print:mt-0 ${isPreview ? 'preview-mode' : ''}`}>
        ...
        {activeDocs.includes('math-maze') && (
          <MathMazeWorksheets key="math-maze" docId="math-maze" seed={effectiveSeed} variant={variant} showAnswersForDoc={showAnswersForDoc} />
        )}
        ...
        {activeDocs.some((d: string) => ['word-search', 'ws-animals', 'ws-space', 'ws-sight-words', 'ws-world'].includes(d)) && (
          <WordSearch
            activeDocs={activeDocs}
            showAnswers={true}
            ...
            variant={variant}
            showAnswersForDoc={showAnswersForDoc}
            docId={activeDocs.find((d: string) => ['word-search', 'ws-animals', 'ws-space', 'ws-sight-words', 'ws-world'].includes(d)) || 'word-search'}
            seed={effectiveSeed}
          />
        )}
        ...
        {(activeDocs.includes('sudoku4') || activeDocs.includes('sudoku6')) && (
          <Sudoku
            ...
            variant={variant}
            showAnswersForDoc={showAnswersForDoc}
            docId={activeDocs.find((d: string) => d.startsWith('sudoku')) || 'sudoku4'}
            seed={effectiveSeed}
          />
        )}
