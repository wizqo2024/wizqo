...
export function Add2Digit100({ seed, variant, showAnswersForDoc }: SpecificWorksheetProps) {
    const { t } = useTranslation()
    ...
    return (
        ...
        >
            ...
            <div className="mb-6 p-4 bg-gradient-to-br from-emerald-50 to-sky-50 border-2 border-emerald-200 rounded-lg print:border print:bg-white">
                ...
                <div className="space-y-3 text-sm">
                    <div className="font-mono text-lg text-emerald-900"><strong>{t('common.problem', 'Problem:')}</strong> <span className="text-2xl">23 + 45 = ?</span></div>
                    {/* Visual representation */}
                    ...
                    <div className="pl-4 border-l-2 border-emerald-300 space-y-1">
                        <div><strong>{t('common.step1', 'Step 1:')}</strong> Add ones: <span className="text-emerald-700 font-bold">3 + 5 = 8</span></div>
                        <div><strong>{t('common.step2', 'Step 2:')}</strong> Add tens: <span className="text-emerald-700 font-bold">20 + 40 = 60</span></div>
                        <div><strong>{t('common.step3', 'Step 3:')}</strong> Combine: <span className="text-emerald-700 font-bold">60 + 8 = 68</span></div>
                        <div className="font-semibold text-emerald-900 mt-2"><strong>{t('common.answer', 'Answer:')}</strong> <span className="text-2xl text-emerald-700">68</span></div>
                        <div className="text-xs text-emerald-700 mt-2 flex items-center gap-1">
                            <span>{String.fromCodePoint(0x279C)}</span>
                            <span>{t('common.tip', 'Tip:')} Add ones first, then tens! No regrouping needed here.</span>
                        </div>
                    </div>
                </div>
            </div>
