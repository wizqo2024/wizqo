...
export function LetterTracingAZ({ showAnswersForDoc }: SpecificWorksheetProps) {
    ...
    const part1 = alphabet.slice(0, 13) // A-M
    const part2 = alphabet.slice(13)     // N-Z
    ...
    return (
        <div className="relative group w-full" ref={containerRef}>
            ...
            >
                ...
                <LetterGrid letters={part1} />
            </WorksheetSectionWrapper>

            {/* PAGE 2: N-Z */}
            <WorksheetSectionWrapper
                docId="letter-tracing-az"
                title="Alphabet Garden Tracing (Part 2)"
                emoji={String.fromCodePoint(0x1F340)}
                description="Continue your garden! Practice letters N through Z."
