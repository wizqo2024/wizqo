...
export default function OrderOfOperationsWorksheetsPage() {
  ...
  const allWorksheets: WorksheetItem[] = useMemo(() => [
    ...
    { title: 'Basic Order of Operations (PEMDAS)', description: 'Start with simple expressions using multiplication, division, addition, and subtraction. Perfect for building confidence in 4th grade students.', href: '/print?doc=pemdas-basic&from=order-of-operations', docId: 'pemdas-basic', categories: ['basic', 'practice'], gradeRange: '4th' },
    { title: 'PEMDAS with Parentheses', description: 'Practice solving expressions with parentheses. Step-by-step exercises that help kids understand which operations come first.', href: '/print?doc=pemdas-parentheses&from=order-of-operations', docId: 'pemdas-parentheses', categories: ['parentheses', 'basic'], gradeRange: '4th' },
    { title: 'Order of Operations Practice Sheet', description: 'Mixed practice problems covering all basic operations. Build fluency with PEMDAS rules through repeated practice.', href: '/print?doc=pemdas-practice&from=order-of-operations', docId: 'pemdas-practice', categories: ['practice', 'basic'], gradeRange: '4th' },
    // 5th Grade - Intermediate worksheets
    { title: 'PEMDAS with Exponents', description: 'Master expressions with exponents. Learn to solve problems like 2³ + 4 × 3 using the correct order of operations.', href: '/print?doc=pemdas-exponents&from=order-of-operations', docId: 'pemdas-exponents', categories: ['exponents', 'multi-step'], gradeRange: '5th' },
    { title: 'Multi-Step PEMDAS Problems', description: 'Challenge yourself with complex expressions combining parentheses, exponents, and all operations. Perfect for 5th grade mastery.', href: '/print?doc=pemdas-multistep&from=order-of-operations', docId: 'pemdas-multistep', categories: ['multi-step', 'exponents'], gradeRange: '5th' },
    { title: 'PEMDAS Word Problems', description: 'Apply order of operations to real-world scenarios. Solve word problems that require careful step-by-step thinking.', href: '/print?doc=pemdas-word-problems&from=order-of-operations', docId: 'pemdas-word-problems', categories: ['word-problems', 'multi-step'], gradeRange: '5th' },
    { title: 'Advanced Parentheses and Exponents', description: 'Tackle challenging problems with nested parentheses and exponents. Build confidence in complex expressions.', href: '/print?doc=pemdas-advanced&from=order-of-operations', docId: 'pemdas-advanced', categories: ['parentheses', 'exponents'], gradeRange: '5th' },
    // 6th Grade - Advanced worksheets
    { title: 'Complex PEMDAS Expressions', description: 'Master the most challenging order of operations problems. Perfect for 6th grade students ready for advanced practice.', href: '/print?doc=pemdas-complex&from=order-of-operations', docId: 'pemdas-complex', categories: ['multi-step', 'exponents'], gradeRange: '6th' },
    { title: 'PEMDAS Rules and Practice', description: 'Comprehensive review of PEMDAS rules with step-by-step examples and practice problems. Great for test preparation.', href: '/print?doc=pemdas-rules&from=order-of-operations', docId: 'pemdas-rules', categories: ['practice', 'basic'], gradeRange: '6th' },
    { title: 'Mixed PEMDAS Review', description: 'Review all PEMDAS concepts with mixed problems. Covers parentheses, exponents, and all operations for complete mastery.', href: '/print?doc=pemdas-mixed-review&from=order-of-operations', docId: 'pemdas-mixed-review', categories: ['practice', 'multi-step'], gradeRange: '6th' },
    // All Grades - Practice and review
    { title: 'PEMDAS Fluency Practice', description: 'Build speed and accuracy with timed PEMDAS practice. Perfect for students who need extra repetition to master the order of operations.', href: '/print?doc=pemdas-fluency&from=order-of-operations', docId: 'pemdas-fluency', categories: ['practice'], gradeRange: 'All' },
    { title: 'Step-by-Step PEMDAS Guide', description: 'Learn PEMDAS with clear step-by-step instructions and worked examples. Ideal for students who struggle with order of operations.', href: '/print?doc=pemdas-step-by-step&from=order-of-operations', docId: 'pemdas-step-by-step', categories: ['basic', 'practice'], gradeRange: 'All' },
  ], [])
