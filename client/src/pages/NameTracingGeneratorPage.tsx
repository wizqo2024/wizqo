...
export default function NameTracingGeneratorPage() {
  ...
  }, [formatName, letterCase, patternStyle, rowCount, margin, pageWidth, pageHeight, baseFontConfig, baseFontSize, sizeMultiplier, fontStyle, lineStyle, showGuideDots, pageDimensions]);
