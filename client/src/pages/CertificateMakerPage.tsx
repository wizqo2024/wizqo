    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-white to-amber-50">
      ...
      <main className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-10">
        <header className="space-y-4 text-center md:text-left">
          <Badge variant="secondary" className="mx-auto w-fit rounded-full border border-indigo-100 bg-white/80 px-4 py-1 text-xs font-semibold uppercase tracking-[0.25em] text-indigo-600 md:mx-0">
            Printables
          </Badge>
          ...
          <p className="mx-auto max-w-3xl text-sm text-slate-600 md:mx-0 md:text-base">
            Personalize the name, award title, message, colors, and style. Preview updates instantly and print in one click—no design skills required.
          </p>
        </header>

        <section className="grid grid-cols-1 items-start gap-10 md:grid-cols-12">
          {/* Left controls */}
          <div className="md:col-span-5">
            <div className="relative overflow-hidden rounded-3xl border border-white/80 bg-white/80 p-6 shadow-xl backdrop-blur-sm sm:p-8">
          ...
          <div className="md:col-span-7 space-y-6">
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="w-full rounded-full border border-white/80 bg-white/70 px-4 py-2 text-center text-xs font-semibold text-slate-500 shadow-sm md:w-auto">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[32px] border border-white/70 bg-white/90 p-4 shadow-[0_25px_70px_-30px_rgba(15,23,42,0.45)] backdrop-blur">
