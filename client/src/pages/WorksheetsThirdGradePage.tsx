...
export default function WorksheetsThirdGradePage() {
  ...
  const THIRD_GRADE_WORKSHEETS: WorksheetItem[] = useMemo(() => [
    ...
    // Cursive
    { title: t('pages.thirdGrade.worksheets.cursiveAlphabet.title'), description: t('pages.thirdGrade.worksheets.cursiveAlphabet.description'), href: getWorksheetURL('cursive-writing-alphabet-worksheets', '3rd-grade'), docId: 'cursive-writing-alphabet-worksheets', categories: ['cursive'], section: 'Cursive Writing', customPreviewUrl: getWorksheetURL('cursive-writing-alphabet-worksheets', '3rd-grade') + '&preview=1' },
    { title: t('pages.thirdGrade.worksheets.cursivePractice.title'), description: t('pages.thirdGrade.worksheets.cursivePractice.description'), href: getWorksheetURL('cursive-writing-practice-sheets', '3rd-grade'), docId: 'cursive-writing-practice-sheets', categories: ['cursive'], section: 'Cursive Writing', customPreviewUrl: getWorksheetURL('cursive-writing-practice-sheets', '3rd-grade') + '&preview=1' },
    { title: t('pages.thirdGrade.worksheets.capitalCursive.title'), description: t('pages.thirdGrade.worksheets.capitalCursive.description'), href: getWorksheetURL('capital-cursive-writing-worksheets', '3rd-grade'), docId: 'capital-cursive-writing-worksheets', categories: ['cursive'], section: 'Cursive Writing', customPreviewUrl: getWorksheetURL('capital-cursive-writing-worksheets', '3rd-grade') + '&preview=1' },
    { title: t('pages.thirdGrade.worksheets.joiningCursive.title'), description: t('pages.thirdGrade.worksheets.joiningCursive.description'), href: getWorksheetURL('joining-cursive-letters-worksheets', '3rd-grade'), docId: 'joining-cursive-letters-worksheets', categories: ['cursive'], section: 'Cursive Writing', customPreviewUrl: getWorksheetURL('joining-cursive-letters-worksheets', '3rd-grade') + '&preview=1' },
    { title: t('pages.thirdGrade.worksheets.printToCursive.title'), description: t('pages.thirdGrade.worksheets.printToCursive.description'), href: getWorksheetURL('half-print-half-cursive-writing', '3rd-grade'), docId: 'half-print-half-cursive-writing', categories: ['cursive'], section: 'Cursive Writing', customPreviewUrl: getWorksheetURL('half-print-half-cursive-writing', '3rd-grade') + '&preview=1' },
  ], [t])
          ...
          <section className="bg-white border border-slate-200 rounded-2xl p-5">
            ...
            <div className="mt-4">
              <div className="border border-slate-200 rounded-xl p-4 bg-white">
                ...
                <a href={addLocaleToPath("/print?doc=pack&time=5&age=g3&skill=math&from=3rd-grade", getLocaleFromURL())} className="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-purple-600 text-white hover:bg-purple-700 transition-colors" onClick={(e) => { try { (window as any).gtag?.('event', 'build_pack_click', { grade: '3' }); } catch { } }}>{t('pages.printables.buildPackButton')}</a>
              </div>
            </div>
          </section>
