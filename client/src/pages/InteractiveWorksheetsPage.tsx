                  ...
                  {pack?.printUrl && (
                    <>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <a
                          href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(typeof window !== 'undefined' ? window.location.href : 'https://wizqo.com/interactive-worksheets-generator')}`}
                          target="_blank"
                          rel="noopener noreferrer"
                        ...
                        <a
                          href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(typeof window !== 'undefined' ? window.location.href : 'https://wizqo.com/interactive-worksheets-generator')}&text=${encodeURIComponent('Free Interactive Worksheets Generator - Unlimited unique printable PDFs with answer keys!')}`}
                          target="_blank"
                          rel="noopener noreferrer"
                        ...
                        <a
                          href={`https://pinterest.com/pin/create/button/?url=${encodeURIComponent(typeof window !== 'undefined' ? window.location.href : 'https://wizqo.com/interactive-worksheets-generator')}&description=${encodeURIComponent('Free Interactive Worksheets Generator - Unlimited unique printable PDFs with answer keys!')}`}
                          target="_blank"
                          rel="noopener noreferrer"
                        ...
                        <button
                          onClick={() => {
                            if (typeof window !== 'undefined' && navigator.share) {
                              navigator.share({
                                title: 'Free Interactive Worksheets Generator',
                                text: 'Unlimited unique printable PDFs with answer keys!',
                          ...
                          aria-label="Share via email or copy link"
                        >
