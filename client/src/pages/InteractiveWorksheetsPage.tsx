  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <SEOMetaTags
        ...
        description="Generate free interactive worksheets for math, reading, science, and SEL. Create printable PDFs with answer keys for grades K-5. Daily refresh. No sign-up!"
