...
- Praise effort, not just results ("You worked hard on that!" instead of "You’re so smart!").
- Give choices ("Would you rather write or draw your answer?").
...
How the best teachers show empathy:

- Greet students by name every morning.
- Validate emotions: "It’s okay to feel nervous before a test."
- Share personal stories — it makes you human, not just an authority figure.
...
- Word Search Adventures: Build vocabulary through themed puzzles.
- Science Scavenger Hunts: Find examples of evaporation or gravity around school.
- Story Starters: Give one line and let imagination take over.
...
- Replace "You’re wrong" with "Let’s figure this out together."
- Let students explain how they reached an answer.
- Use puzzles, riddles, and logic worksheets.
...
- Visual: charts, drawings, printable worksheets.
