...
function main() {
  ...
  routes.push({ path: '/worksheets/2nd-grade-math-worksheets', title: 'Grade 2 Math Worksheets – Free Printable PDF | 2nd Grade Math', description: 'Free grade 2 math worksheets covering counting, place value, addition/subtraction within 20 and 100, and focus skills. Download printable PDF worksheets for grade 2 math practice.', keywords: 'grade 2 math worksheets, 2nd grade math worksheets, second grade math worksheets, free 2nd grade math worksheets PDF, printable math worksheets grade 2, addition worksheets second grade, subtraction worksheets grade 2, place value worksheets, counting worksheets grade 2, grade 2 math worksheets free, math worksheets for grade 2' });
