...
function main() {
  ...
  // Worksheets
  routes.push({ path: '/worksheets/all', title: 'All Free Printable Worksheets | Math, Reading, Writing & More | Wizqo', description: 'Browse all free printable worksheets for kids (K-5). Math, reading, writing, tracing, and multiplication worksheets with answer keys—100% free, ready to print.', keywords: 'all worksheets, free printable worksheets, math worksheets, reading worksheets, writing worksheets, worksheets for kids, kindergarten worksheets, 1st grade worksheets, 2nd grade worksheets, 3rd grade worksheets, 4th grade worksheets, 5th grade worksheets' });
