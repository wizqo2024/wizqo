...
function main() {
  ...
  routes.push({ path: '/contact', title: 'Contact Wizqo - Questions & Feedback Welcome', description: 'Got a question or suggestion? Reach out to Wizqo\'s team — we typically respond within 24 hours. Let’s improve your hobby journey together' });
