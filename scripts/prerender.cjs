...
function main() {
  ...
  routes.push({ path: '/worksheets-1', title: '1st Grade Math Worksheets – Free Printable PDF', description: 'Free 1st grade math worksheets—number sense, addition/subtraction within 10, ten‑frames, skip counting, and shapes. Print or save as PDF.', keywords: '1st grade math worksheets, first grade math worksheets, free 1st grade math worksheets PDF, printable math worksheets grade 1' });
  routes.push({ path: '/interactive-worksheets-generator', title: 'Interactive Worksheets Generator | Free Printable PDF Activities', description: 'Generate interactive worksheets for math, reading, science, SEL, and more. Free printable PDFs with daily refresh and answer keys for every grade.', keywords: 'interactive worksheets, worksheet generator, printable worksheets generator, free worksheet maker, create worksheets online, math worksheet generator, reading worksheet generator' });
  ...
  routes.push({ path: '/privacy', title: 'Privacy Policy - Wizqo', description: 'Learn how Wizqo protects your privacy and handles your data while providing free printable worksheets and personalized learning experiences.', keywords: 'privacy policy, data protection, user privacy, educational platform privacy' });
  routes.push({ path: '/terms', title: 'Terms of Service - Wizqo', description: "Read Wizqo's terms of service and understand the rules and guidelines for using our educational platform and worksheet generator.", keywords: 'terms of service, user agreement, platform terms, educational website terms' });
  routes.push({ path: '/cookies', title: 'Cookie Policy - How Wizqo Uses Cookies | Transparent Data Practice', description: 'Understand how Wizqo uses cookies to enhance your learning experience. Comprehensive cookie policy covering types, purposes, and your control options.', keywords: 'cookie policy, website cookies, data cookies, privacy cookies' });
